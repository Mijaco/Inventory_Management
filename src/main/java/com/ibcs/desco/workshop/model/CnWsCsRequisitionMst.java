...
@Entity
@Table(name = "CN_WS_CS_REQUISITION_MST")
public class CnWsCsRequisitionMst {

	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cn_ws_cs_requis_mst_id_seq")
	@SequenceGenerator(name = "cn_ws_cs_requis_mst_id_seq", sequenceName = "cn_ws_cs_requis_mst_id_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
