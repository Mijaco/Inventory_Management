...
public interface WSTransformerService {
	...
	Object getObjectListbyThreeColumnAndOneNotNullColumn(String objectName, String columnName1,
			String columnValue1, String columnName2, String columnValue2, String columnName3, String columnValue3, String notNullColumnName );
	...
	List<Contractor> getContractorList(String type);
