...
@Entity
@Table(name = "COST_ESTIMATE_RECOVERY_DTL")
public class CostEstimateRecoveryDtl {

	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cost_estimate_rec_dtl_id_seq")
	@SequenceGenerator(name = "cost_estimate_rec_dtl_id_seq", sequenceName = "cost_estimate_rec_dtl_id_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
