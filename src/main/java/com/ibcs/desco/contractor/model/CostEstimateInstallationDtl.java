...
@Entity
@Table(name = "COST_ESTIMATE_INSTALLATION_DTL")
public class CostEstimateInstallationDtl {

	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "Cost_Estimate_Ins_dtl_id_seq")
	@SequenceGenerator(name = "Cost_Estimate_Ins_dtl_id_seq", sequenceName = "Cost_Estimate_Ins_dtl_id_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
