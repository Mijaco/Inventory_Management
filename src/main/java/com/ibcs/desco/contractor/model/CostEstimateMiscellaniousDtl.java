...
@Entity
@Table(name = "COST_ESTIMATE_MISC_DTL")
public class CostEstimateMiscellaniousDtl {

	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "Cost_estimate_mis_dtl_id_seq")
	@SequenceGenerator(name = "Cost_estimate_mis_dtl_id_seq", sequenceName = "Cost_estimate_mis_dtl_id_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
