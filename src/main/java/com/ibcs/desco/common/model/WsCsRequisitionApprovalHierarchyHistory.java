...
@Entity
@Table(name = "WS_CS_REQUIS_APP_HIER_HIST")
public class WsCsRequisitionApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ws_cs_requis_app_hier_his_seq")
	@SequenceGenerator(name = "ws_cs_requis_app_hier_his_seq", sequenceName = "ws_cs_requis_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
