...
@Entity
@Table(name = "JOB_CARD_APP_HIER_HIST")
public class JobCardApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "job_card_app_hier_his_seq")
	@SequenceGenerator(name = "job_card_app_hier_his_seq", sequenceName = "job_card_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
