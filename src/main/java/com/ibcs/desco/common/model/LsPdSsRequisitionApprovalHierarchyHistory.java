...
@Entity
@Table(name = "LS_SS_PD_REQ_APP_HIER_HIST")
public class LsPdSsRequisitionApprovalHierarchyHistory {
	
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ls_pd_ss_req_app_hier_his_seq")
	@SequenceGenerator(name = "ls_pd_ss_req_app_hier_his_seq", sequenceName = "ls_pd_ss_req_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
	
	// ls_ss_requis_app_hier_his_Seq
	...
	public void setHistoryChange(String historyChange) {
