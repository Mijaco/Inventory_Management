...
@Entity
@Table(name = "JOB_ESTIMAT_APP_HIER_HIST")
public class JobEstimationApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "job_est_app_hier_his_Seq")
	@SequenceGenerator(name = "job_est_app_hier_his_Seq", sequenceName = "job_est_app_hier_his_Seq", allocationSize = 1, initialValue = 1)
	private Integer id;
