...
@Entity
@Table(name = "LOCAL_REQUIS_APP_HIER_HIST")
public class LocalRequisitionApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "local_requis_app_hier_his_seq")
	@SequenceGenerator(name = "local_requis_app_hier_his_seq", sequenceName = "local_requis_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
