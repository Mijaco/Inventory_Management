...
@Entity
@Table(name = "LS_CS_PD_REQ_APP_HIER_HIST")
public class LsPdCsRequisitionApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ls_pd_cs_req_app_hier_his_seq")
	@SequenceGenerator(name = "ls_pd_cs_req_app_hier_his_seq", sequenceName = "ls_pd_cs_req_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
