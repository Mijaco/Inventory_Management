...
@Entity
@Table(name = "WS_INV_RPT_HIER_HIST")
public class WsInventoryReportApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ws_inv_rpt_hier_his_seq")
	@SequenceGenerator(name = "ws_inv_rpt_hier_his_seq", sequenceName = "ws_inv_rpt_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
