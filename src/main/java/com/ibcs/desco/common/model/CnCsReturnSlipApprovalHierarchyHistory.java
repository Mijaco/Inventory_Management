...
@Entity
@Table(name = "CN_CS_RS_APP_HIER_HIST")
public class CnCsReturnSlipApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cn_cs_rs_app_hier_his_seq")
	@SequenceGenerator(name = "cn_cs_rs_app_hier_his_seq", sequenceName = "cn_cs_rs_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
