...
@Entity
@Table(name = "APP_PUR_APPRV_HIER_HIST")
public class AppPurchaseApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "APP_PUR_HIER_HIST_SEQ")
	@SequenceGenerator(name = "APP_PUR_HIER_HIST_SEQ", sequenceName = "APP_PUR_HIER_HIST_SEQ", allocationSize = 1, initialValue = 1)
	private Integer id;
	...
	public AppPurchaseApprovalHierarchyHistory() {

	}

	public AppPurchaseApprovalHierarchyHistory(Integer id,
			String operationName, AppPurchaseMst appPurchaseMst,
			AuthUser authUser, Departments department, Integer stateCode,
			String stateName, String justification, String status,
			String remarks, String approvalHeader, String createdBy,
			Date createdDate) {
		super();
		this.id = id;
		this.operationName = operationName;
	...
	public String toString() {
		return "AppPurchaseApprovalHierarchyHistory [id=" + id
				+ ", operationName=" + operationName + ", appPurchaseMst="
				+ appPurchaseMst + ", stage=" + stage + ", return_to="
