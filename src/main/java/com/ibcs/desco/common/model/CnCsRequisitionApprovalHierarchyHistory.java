...
@Entity
@Table(name = "CN_CS_REQUIS_APP_HIER_HIST")
public class CnCsRequisitionApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cn_cs_requis_app_hier_his_seq")
	@SequenceGenerator(name = "cn_cs_requis_app_hier_his_seq", sequenceName = "cn_cs_requis_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
