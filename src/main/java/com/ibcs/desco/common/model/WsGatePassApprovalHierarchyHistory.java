...
@Entity
@Table(name = "WS_GATE_PASS_HIER_HIST")
public class WsGatePassApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ws_gp_hier_his_seq")
	@SequenceGenerator(name = "ws_gp_hier_his_seq", sequenceName = "ws_gp_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
