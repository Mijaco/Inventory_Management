...
@Entity
@Table(name = "TT_APP_HIER_HIST")
public class TransformerTestApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TT_APP_HIER_HIST_SEQ")
	@SequenceGenerator(name = "TT_APP_HIER_HIST_SEQ", sequenceName = "TT_APP_HIER_HIST_SEQ", allocationSize = 1, initialValue = 1)
	private Integer id;
