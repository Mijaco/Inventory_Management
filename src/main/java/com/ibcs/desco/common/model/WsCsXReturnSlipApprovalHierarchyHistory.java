...
@Entity
@Table(name = "WS_CS_X_RS_APP_HIER_HIST")
public class WsCsXReturnSlipApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ws_cs_x_rs_app_hier_his_seq")
	@SequenceGenerator(name = "ws_cs_x_rs_app_hier_his_seq", sequenceName = "ws_cs_x_rs_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
