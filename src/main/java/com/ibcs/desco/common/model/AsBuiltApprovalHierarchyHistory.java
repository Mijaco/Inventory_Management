...
@Entity
@Table(name = "AS_BUILT_APP_HIER_HIST")
public class AsBuiltApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "as_built_app_hier_his_Seq")
	@SequenceGenerator(name = "as_built_app_hier_his_Seq", sequenceName = "as_built_app_hier_his_Seq", allocationSize = 1, initialValue = 1)
	private Integer id;
