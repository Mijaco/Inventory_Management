...
@Entity
@Table(name = "WS_PREV_HIER_HIST")
public class WsLsRCVPreventiveApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ws_prev_hier_his_seq")
	@SequenceGenerator(name = "ws_prev_hier_his_seq", sequenceName = "ws_prev_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
