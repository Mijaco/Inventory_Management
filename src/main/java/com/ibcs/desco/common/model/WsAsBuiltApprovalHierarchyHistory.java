...
@Entity
@Table(name = "WS_AS_BUILT_APP_HIER_HIST")
public class WsAsBuiltApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ws_as_built_app_hier_his_Seq")
	@SequenceGenerator(name = "ws_as_built_app_hier_his_Seq", sequenceName = "ws_as_built_app_hier_his_Seq", allocationSize = 1, initialValue = 1)
	private Integer id;
