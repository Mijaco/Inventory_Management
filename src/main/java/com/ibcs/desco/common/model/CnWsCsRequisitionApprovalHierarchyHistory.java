...
@Entity
@Table(name = "CN_WS_CS_REQ_APP_HIER_HIST")
public class CnWsCsRequisitionApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cn_ws_cs_req_app_hier_his_seq")
	@SequenceGenerator(name = "cn_ws_cs_req_app_hier_his_seq", sequenceName = "cn_ws_cs_req_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
