...
@Entity
@Table(name = "JOB_ASSIGN_APP_HIER_HIST")
public class JobAssignApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "job_asign_app_hier_his_seq")
	@SequenceGenerator(name = "job_asign_app_hier_his_seq", sequenceName = "job_asign_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;

	// job_asign_app_hier_his_seq
