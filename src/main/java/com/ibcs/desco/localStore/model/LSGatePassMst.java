...
public class LSGatePassMst {
	...
	public LSGatePassMst(){}

	public LSGatePassMst(Integer id, String gatePassNo, Date gatePassDate,
			String ticketNo, String requisitonNo, String workOrderNo,
			String issuedTo, String issuedBy, String carriedTo,
			String receivedBy, String receiverName, boolean flag,
			String status, boolean active, String createdBy, Date createdDate) {
		super();
		this.id = id;
