...
@Entity
@Table(name = "LOCAL_REQUISITION_MST")
public class LocalRequisitionMst {

	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "local_requis_mst_id_seq")
	@SequenceGenerator(name = "local_requis_mst_id_seq", sequenceName = "local_requis_mst_id_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
