...
function approveing() {
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		var path=contextPath+"/cnpd/approveCnPdSSRequisition.do";
...
function rejectProcess() {
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		var contextPath = $('#contextPath').val()
		var path = contextPath + "/cnpd/ss/itemRequisitionReject.do";
...
/*function approveing() {
	...
	if (quantityIssued.length > 0) {
		window.location = $('#contextPath').val()
				+ "/cnpd/approveCnPdRequisition.do?requisitionNo="
