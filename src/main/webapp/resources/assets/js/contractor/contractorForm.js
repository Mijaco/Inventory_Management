	...
	$(document)
			.on(
					...
					function(e) {
						...
						var repEmailDiv = childDiv
								.getElementsByTagName('div')[3], repEmailInput = repEmailDiv
								.getElementsByTagName('input')[0];
						repEmailInput.setAttribute('id', 'repEmail'+ newNum);
						
						var errUserEmailDiv = childDiv
						.getElementsByTagName('div')[3], errUserEmailInput = repEmailDiv
						.getElementsByTagName('h5')[0];
						...
						var startDateDiv = childDiv
								.getElementsByTagName('div')[7], startDateInput = startDateDiv
								.getElementsByTagName('input')[0];
						...
						var endDateDiv = childDiv
								.getElementsByTagName('div')[8], endDateInput = endDateDiv
								.getElementsByTagName('input')[0];
