...
function forwardToUpper(stateCode) {
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		window.location = contextPath + "/cn/returnSlip/sendToCn.do?returnSlipNo="
				+ returnSlipNo
				+ "&justification="
				+ justification
				+ "&stateCode="
...
function backToLower(stateCode) {
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		// window.location =
		// "${pageContext.request.contextPath}/cs/itemRecieved/itemReceivedForwordTo.do?receivedReportNo="+param1+"$justification="+justification;
		window.location = contextPath + "/cn/returnSlip/backToCn.do?returnSlipNo="
				+ returnSlipNo
				+ "&justification="
				+ justification
				+ "&stateCode="
...
function approveing() {
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		window.location = contextPath + "/cn/itemReturnSlipApprovedCn.do?returnSlipNo="
				+ returnSlipNo
				+ "&justification="
				+ justification
