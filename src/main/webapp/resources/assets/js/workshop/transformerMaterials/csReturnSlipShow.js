function forwardToUpper(stateCode) {
	...
	window.location = $("#contextPath").val()
			+ "/wsm/returnSlip/sendTo.do?returnSlipNo=" + returnSlipNo
...
function backToLower(stateCode) {
	...
	window.location = $("#contextPath").val()
			+ "/wsm/returnSlip/backTo.do?returnSlipNo=" + returnSlipNo
			+ "&justification=" + justification + "&stateCode=" + stateCode;
}
...
function approveReturnSlip() {
	...
	var path = $("#contextPath").val() + '/wsm/returnSlip/itemReturnSlipApproved.do';
