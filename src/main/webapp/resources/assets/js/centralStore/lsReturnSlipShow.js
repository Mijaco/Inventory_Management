...
function forwardToUpper(stateCode) {
	...
	window.location = $('#contextPath').val() + "/c2ls/returnSlip/sendTo.do?returnSlipNo="
			+ returnSlipNo
			+ "&justification="
			+ justification
			+ "&stateCode="
...
function backToLower(stateCode) {
	...
	// window.location =
	// "${pageContext.request.contextPath}/cs/itemRecieved/itemReceivedForwordTo.do?receivedReportNo="+param1+"$justification="+justification;
	window.location = $('#contextPath').val() + "/c2ls/returnSlip/backTo.do?returnSlipNo="
			+ returnSlipNo
			+ "&justification="
			+ justification
			+ "&stateCode="
...
function approveing() {
	...
	window.location = $('#contextPath').val() + "/c2ls/itemReturnSlipApproved.do?returnSlipNo="
			+ returnSlipNo
			+ "&justification="
			+ justification
