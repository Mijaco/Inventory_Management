...
function forwardToUpper(stateCode) {
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		window.location = $('#contextPath').val() + "/ss/returnSlip/sendTo.do?returnSlipNo="
				+ returnSlipNo
				+ "&justification="
				+ justification
				+ "&stateCode="
...
function backToLower(stateCode) {
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		window.location = $('#contextPath').val() + "/ss/returnSlip/backTo.do?returnSlipNo="
				+ returnSlipNo
				+ "&justification="
				+ justification
				+ "&stateCode="
...
function approveing() {
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		window.location = $('#contextPath').val() + "/ss/returnSlip/itemReturnSlipApproved.do?returnSlipNo="
				+ returnSlipNo
				+ "&justification="
				+ justification
								...
								$.ajax({
									...
									success : function(data) {
										...
										var r = $("#tblAppendGrid").attr(
												"data-rowid");
										$("#qtyNewServiceableRcv" + r).text(
												sData.qtyNewServiceableRcv
														.toFixed(3));
										$("#qtyRecServiceableRcv" + r).text(
												sData.qtyRecServiceableRcv
														.toFixed(3));
										$("#qtyUnServiceableRcv" + r).text(
