	...
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		if (quantityIssued.length > 0) {
			window.location = $('#contextPath').val()
					+ "/ls/requisition/sendTo.do?requisitionNo=" + requisitionNo
					+ "&justification=" + justification + "&stateCode=" + stateCode
					+ "&issueqty=" + quantityIssued;
		}
	}
}
...
function backToLower(stateCode) {
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		var requisitionNo = $('#requisitionNo').val();
		window.location = $('#contextPath').val()
				+ "/ls/requisition/backTo.do?requisitionNo=" + requisitionNo
				+ "&justification=" + justification + "&stateCode=" + stateCode;
	}
}
...
function approveing() {
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		if (quantityIssued.length > 0) {
			window.location = $('#contextPath').val()
					+ "/ls/itemRequisitionSubmitApproved.do?requisitionNo="
...
function rejectProcess() {
	if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
		...
		var path = contextPath + "/ls/cs/itemRequisitionReject.do";
