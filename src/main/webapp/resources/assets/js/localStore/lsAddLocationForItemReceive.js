...
function setTotalQtyByUuidAndItemCode() {
	...
	.ajax({
		type : "POST",
		contentType : "application/json; charset=utf-8",
		url : $('#contextPath').val()+'/ls/itemRecieved/getSSTotalQtyByUuidAndItemCode.do',
...
function getTotalQtyByUuidAndItemCode() {
	...
	.ajax({
		...
		contentType : "application/json; charset=utf-8",
		url : $('#contextPath').val()
				+ "/ls/itemRecieved/getSSTotalQtyByUuidAndItemCode.do",
		data : cDataJsonString,
		success : function(data) {
			//set updated value in rcv qty
			$("#issuedQty" + rowId).val(data);
...
function editItemLocation(itemCode, rowid) {
	...
	$
			.ajax({
				...
				contentType : "application/json; charset=utf-8",
				url : $('#contextPath').val()
						+ "/ls/itemRecieved/getTemplocation.do",
				data : cDataJsonString,
				success : function(data) {
					$('#dynamicTable').append(
...
function updateLocationQty(pk, index) {
	...
	$.ajax({
		...
		contentType : "application/json; charset=utf-8",
		url : $('#contextPath').val()
				+ "/ls/itemRecieved/updateSSLocationQty.do",
		data : cDataJsonString,
		success : function(data) {
			alert(data);
		},
...
function deleteLocationQty(pk, index) {
	...
	$.ajax({
		...
		contentType : "application/json; charset=utf-8",
		url : $('#contextPath').val()
				+ "/ls/itemRecieved/deleteSSLocationQty.do",
		data : cDataJsonString,
		success : function(data) {					
			alert(data);
