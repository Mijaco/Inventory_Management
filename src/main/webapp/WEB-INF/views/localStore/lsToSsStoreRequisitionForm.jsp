...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row"
		...
		<!-- --------------------- -->
		<form method="POST"
			action="${pageContext.request.contextPath}/ls/storeRequisitionSave.do">
			<div class="oe_title">
													...
													<div class="aaa">
														...
														<div class="col-xs-12 entry" id="myArea0">
															<div class="row">
																...
																<div class="form-group col-sm-1 col-xs-12">
																	<input class="form-control" name="headOfAccount"
																		type="text"
																		style="border: 0; border-bottom: 2px ridge;" />
																</div>
																<div class="form-group col-sm-1 col-xs-12">
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/localStore/lsToCsStoreRequisitionForm.js"></script>
<!-- ------------------------------------Start of Footer-------------------------------------------------- -->
