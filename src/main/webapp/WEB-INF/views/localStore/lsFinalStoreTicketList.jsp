		...
		<div class="col-sm-12 table-responsive">
			...
			<c:if test="${!empty storeTicketMstList}">
				<div class="col-sm-12 pull-right">
					<form method="POST"
						action="${pageContext.request.contextPath}/ls/storeTicket/finalListSearch.do">
						...
						<div class="form-group col-xs-2">
							<select class="form-control storeTicketType" name="storeTicketType"
								...
								<option value="LS_ISSUED_REQUISITION">Item Issued</option>
								<option value="CN2_LS_RETURN_SLIP">Item Received</option>
							</select>
						</div>
						...
						<c:forEach items="${storeTicketMstList}" var="storeTicketMst">
							...
							<tr>
								...
								<td><a href="javascript:void(0)" class="blue"
									onclick="postSubmit('${pageContext.request.contextPath}/ls/storeTicket/detailsInfo.do',{id:'${storeTicketMst.id}'},'POST')">
