							...
							<tr>
								<td>
									<c:choose>
										...
										<c:otherwise>
											<a
												href="${pageContext.request.contextPath}/${returnSlipMst.senderStore}/returnSlip/pageShow.do?id=${returnSlipMst.id}&returnTo=${returnSlipMst.returnTo}"
												style="text-decoration: none;"><c:out
												value="${returnSlipMst.returnSlipNo}" /></a>
										</c:otherwise>
									</c:choose>
								...
								<td>XEN, ${returnSlipMst.returnTo=='cs'?'Central Store':'Sub Store'}</td>
