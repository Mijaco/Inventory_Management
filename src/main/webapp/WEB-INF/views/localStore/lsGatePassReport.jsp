...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			...
			<input type="hidden" value="${gatePassNo}" id="gatePassNo" /> 
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						var param1 = document.getElementById("gatePassNo").value;
						
						
	
						//var param2   = document.getElementById("param2").value;
						//param1="DESCO/2015-2016/PRF001";
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/con_to_ls_gate_pass.rptdesign&__toolbar=false&__showtitle=false&__title=&P_GATE_PASS_NO='+ param1;
