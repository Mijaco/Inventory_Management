		...
		<div class="col-sm-12 table-responsive">
			<form
				...
				<input type="hidden" id="contextPath"
					...
					type="hidden" id="rowId"> <input type="hidden"
					id="buttonType">
					...
					<tbody>
						...
						<tr>
							...
							<td class="col-sm-4"><input type="text" name="receiverName"
								...
								style="width: 100%;">
								<strong class="receiverName text-danger hide">This field is required</strong>
								</td>
							<td class="col-sm-2 success text-right"
							...
							<td class="col-sm-4"><input type="text" name="deliveryDate"
								...
								<strong class="deliveryDate text-danger hide">This field is required</strong>
							</td>
						</tr>
						<tr>
							<td class="col-sm-2 success text-right"
						...
						<tr>
							...
							<strong class="woId text-danger hide">This field is required</strong>
							...
							<strong class="itemCode text-danger hide">This field is required</strong>
							</td>
						</tr>
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/localStore/auction/condemnMaterials.js"></script>
<!-- -------------------------------------------------------------------------------------- -->
