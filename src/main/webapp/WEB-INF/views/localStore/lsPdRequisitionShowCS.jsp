...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<input type="hidden" id="requisitionTo" value="${requisitionTo}">
		...
		<div class="oe_title">
			...
			<table class="col-sm-12 table">
				<tr class="">
					...
					<td class="info"><b>${centralStoreRequisitionMst.khathName}</b></td>
				</tr>
				<tr class="">
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/centralStore/lsPdRequisitionShowCS.js"></script>
<!-- ------------------------------------Start of Footer-------------------------------------------------- -->
