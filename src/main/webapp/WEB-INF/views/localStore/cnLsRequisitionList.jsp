...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row"
		...
		<%-- 		<div class="col-sm-6 pull-right">
					<form method="POST"
						action="${pageContext.request.contextPath}/c2ls/requisitionSearch.do">
				...
				<table id="centralStoreRequisitionListTable"
					...
					<tbody>
						<c:forEach items="${centralStoreRequisitionMstList}"
							...
							<tr>
								<td><a
									href="${pageContext.request.contextPath}/c2ls/storeRequisitionShow.do?id=${centralStoreRequisitionMst.id}&requisitionTo=${centralStoreRequisitionMst.requisitionTo}"
