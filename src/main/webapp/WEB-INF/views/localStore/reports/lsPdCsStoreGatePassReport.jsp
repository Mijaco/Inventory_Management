...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h4 class="center blue col-md-offset-3 col-md-6"
			...
			Gate Pass No : <input type="text" id="param1" name="param1"
				style="width: 40%">
...
<script type="text/javascript">
	...
	function query() {
		...
		+ '?__report=desco/procurement/ls_pd_cs_req_gp.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TICKET_NO='
		+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
