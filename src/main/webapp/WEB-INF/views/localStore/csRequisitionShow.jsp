...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h2 class="center blue ubuntu-font" style="margin-top: 0px;">Store Requisition</h2>
	...
	<div class="row"
					...
					<table class="col-sm-12 table">
						...
						<tr class="">
							...
							<tr class="">
								...
								<c:if test="${!empty itemRcvApproveHistory.historyChange}">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 text-center">				
				<button class="btn btn-primary" onclick="approveing()" id="approveButton" type="button"
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/centralStore/csRequisitionShow.js"></script>
<!-- ------------------------------------Start of Footer-------------------------------------------------- -->
