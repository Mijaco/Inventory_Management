...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			...
			<h2 class="center blue"
				style="margin-top: 0; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Received
				List After Requisition Approval</h2>
	...
	<div class="row"
		...
		<div class="col-sm-12 table-responsive">
			<c:if test="${empty subStoreRequisitionMstList}">
			...
			<c:if test="${!empty subStoreRequisitionMstList}">
				...
				<!-- 					<form method="POST" -->
				<%-- 						action="${pageContext.request.contextPath}/ls/itemRecieved/requisitionReceivedSearch.do"> --%>
				...
				<table id="subStoreRequisitionListTable"
					...
					<tbody>
						<c:forEach items="${subStoreRequisitionMstList}"
							var="subStoreRequisitionMst">

							<c:choose>
								<c:when test="${!subStoreRequisitionMst.received}">
									<tr class="info" style="font-weight: bold; color: green;">
										<td style="">${subStoreRequisitionMst.id}</td>
										<td><a
											href="${pageContext.request.contextPath}/ls/itemRecieved/storeRequisitionReceivedShow.do?id=${subStoreRequisitionMst.id}&requisitionTo=${subStoreRequisitionMst.requisitionTo}"
											style="text-decoration: none;"><c:out
													value="${subStoreRequisitionMst.requisitionNo}" /></a></td>
										<td><c:out
												value="${subStoreRequisitionMst.identerDesignation}" /></td>
										<td><fmt:formatDate
												value="${subStoreRequisitionMst.requisitionDate}"
										...
										<td class="col-xs-2 center">
											<div class="action-buttons">
												<a class="btn btn-primary btn-xs"
													...
													href="${pageContext.request.contextPath}/ls/itemRecieved/storeRequisitionReceivedShow.do?id=${subStoreRequisitionMst.id}&received=${subStoreRequisitionMst.received}">
								...
								<c:otherwise>
									<tr class="default">
										<td>${subStoreRequisitionMst.id}</td>
										<td><a
											href="${pageContext.request.contextPath}/ls/itemRecieved/storeRequisitionReceivedShow.do?id=${subStoreRequisitionMst.id}&requisitionTo=${subStoreRequisitionMst.requisitionTo}"
											style="text-decoration: none;"><c:out
													value="${subStoreRequisitionMst.requisitionNo}" /></a></td>
...
<script type="text/javascript">
	$(document)
			.ready(
					function() {
						$('#subStoreRequisitionListTable').DataTable({
							"columnDefs" : [ {
								"targets" : [ 0 ],
								"visible" : false,
								"searchable" : false
						...
						document
								.getElementById('subStoreRequisitionListTable_length').style.display = 'none';
						//document.getElementById('subStoreRequisitionListTable_filter').style.display = 'none';
