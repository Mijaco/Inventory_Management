				...
				<table id="centralStoreRequisitionListTable"
					...
					<tbody>
						<c:forEach items="${centralStoreRequisitionMstList}"
							...
							<tr>
								<td><a
									href="${pageContext.request.contextPath}/${centralStoreRequisitionMst.senderStore}/storeRequisitionShowOfLocalToSub.do?id=${centralStoreRequisitionMst.id}&&requisitionTo=${centralStoreRequisitionMst.requisitionTo}"
