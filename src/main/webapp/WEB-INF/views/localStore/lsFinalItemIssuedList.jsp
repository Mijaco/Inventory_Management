...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row" style="background-color: white; padding: 10px; margin: 10px;">
		...
		<div class="col-sm-12 table-responsive">
			<c:if test="${empty lsIssuedMstList}">
			...
			<c:if test="${!empty lsIssuedMstList}">
				<div class="col-sm-12 pull-right">
					<form method="POST"
						action="${pageContext.request.contextPath}/ls/issued/finalListSearch.do">
						...
						<div class="form-group col-xs-2">
							<select class="form-control senderStore"
								...
								<option value="cn">Contracor</option>
							</select>
						</div>
				...
				<table id="lsIssuedMstListTable"
					...
					<tbody>
						<c:forEach items="${lsIssuedMstList}" var="lsIssuedMst" varStatus="loop">
							<tr>
								<td><a href="#" class="blue"
									onclick="postSubmit('${pageContext.request.contextPath}/ls/issued/detailsInfo.do',{id:'${lsIssuedMst.id}'},'POST')">
										<c:out value="${lsIssuedMst.requisitionNo}" />								</a></td>
								<td><fmt:formatDate value="${lsIssuedMst.requisitionDate}"
										pattern="dd-MM-yyyy" /></td>
								<td><c:out value="${lsIssuedMst.storeTicketNO}" /></td>
								<td><c:out value="${lsIssuedMst.gatePassNo}" /></td>
								...
								<%-- <td><c:out value="${csIssuedMst.approved}" /></td>
								<td><c:out value="${csIssuedMst.received}" /></td> --%>
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						$('#lsIssuedMstListTable').DataTable();
						document.getElementById('lsIssuedMstListTable_length').style.display = 'none';
						document.getElementById('lsIssuedMstListTable_filter').style.display = 'none';
					});
</script>
