			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<!-- class="ace-icon fa fa-leaf green" -->
								<i><img alt=""
									src="${pageContext.request.contextPath}/resources/assets/images/logo.png"></i>
								<!-- <span class="red">ICAB</span> -->
								<!-- <span class="white" id="id-text2">Application</span> -->
							</h1>
							<!-- <h4 class="blue" id="id-company-text">&copy; The Institute of Chartered Accountants of Bangladesh </h4> -->
						</div>
						...
						<div class="position-relative">
							<div id="login-box"
								...
								<div class="widget-body">									
									<div class="widget-main">
										...
										<div class="red center">${errors}</div>
									</c:if>
										<div class="space-6"> </div>
							...
							<div class="alert alert-success hide">
								...
								<strong>Success!</strong> Password is updated and active from
								next login.
							</div>
...
<![endif]-->
	<script type="text/javascript">
		if ('ontouchstart' in document.documentElement)
			document
					.write("<script src='${pageContext.request.contextPath}/resources/assets/js/jquery.mobile.custom.min.js'>"
							+ "<"+"/script>");
	</script>
