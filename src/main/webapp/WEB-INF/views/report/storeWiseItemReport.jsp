...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"
			style="margin-top: 10px; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Store wise Item Report</h1>
	</div>
			...
			<div class="form-group col-xs-6">
				...
				<div class="col-xs-8">
					<input type="text" class="form-control" id="param1" name="param1"
						value="900.130" style="width: 100%"> <input
			...
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr
								+ '?__report=desco/procurement/store_wise_item_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_ITEM_CODE='
								+ param1;
