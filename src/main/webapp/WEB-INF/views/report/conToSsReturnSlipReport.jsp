...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"
				...
				To Sub Store Return Slip Report</h1>
	</div>
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/con_to_ss_return_slip_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_RETURN_SLIP_NO='+ param1;
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/con_to_ss_return_slip_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_RETURN_SLIP_NO='
				+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
