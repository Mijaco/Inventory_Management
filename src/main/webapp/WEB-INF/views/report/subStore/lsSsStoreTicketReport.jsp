...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h4 class="center blue col-md-offset-3 col-md-6"
			...
			Store Ticket No : <input type="text" id="param1" name="param1"
				style="width: 40%">
...
<script type="text/javascript">
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/ls_to_ss_req_st.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TICKET_NO='
				+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
