		...
		<div class="col-sm-12 table-responsive">
			...
			<div class="form-group col-xs-9">
				<div class="form-group col-xs-3">
					<label for="exampleInputName2">Vehicle Permission No:</label>
				</div>
				<div class="col-xs-9">
					<input type="text" class="form-control" id="param1" name="param1"
						value="VP0720160900000005" style="width: 100%">
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/cs_vehicle_permission_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_SLIP_NO='+ param1;
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/cs_vehicle_permission_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_SLIP_NO='+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
