...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"
			style="margin-top: 10px; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Central Store 
			Gate Pass Report</h1>
	</div>
			...
			<div class="form-group col-xs-6">
				...
				<div class="col-xs-9">
					<input type="text" class="form-control" id="param1" name="param1"
						value="GP0720160500000042" style="width: 100%"> <input
			...
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr
								+ '?__report=desco/procurement/cs_gate_pass_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_GATE_PASS_NO='
								+ param1;
