		...
		<div class="col-sm-12 table-responsive">
			...
			<div class="form-group col-xs-9">
				<div class="form-group col-xs-3">
					<label for="param1" class="control-label align-right">Vehicle Permission No. :</label>
				</div>
				<div class="col-xs-9">
					<input type="text" class="form-control" id="param1" name="param1"
						value="VP0120160900000007" style="width: 100%">
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/ss_vehicle_permission_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_SLIP_NO='+ param1;
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/ss_vehicle_permission_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_SLIP_NO='+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
