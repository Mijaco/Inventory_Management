...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h4 class="center blue col-md-offset-3 col-md-6"
			style="font-style: italic; margin-top: 0px; margin-left: 50px; font-family: 'Ubuntu Condensed', sans-serif;">Local
			RR No: <input type="text" id="param1" name="param1"
						style="width: 40%"> 
...
function query() {
	...
	document.getElementById('requisitionReportFrame').src = birtAddr
			+ '?__report=desco/procurement/local_receiving_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_LRR_NO='
			+ param1;
