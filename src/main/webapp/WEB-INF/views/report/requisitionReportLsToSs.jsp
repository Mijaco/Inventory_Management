			...
			<div class="form-group col-xs-6">
				...
				<div class="col-xs-9">
					<input type="text" class="form-control" id="param1" name="param1"
						value="SR0420160500000081" style="width: 100%"> <input
			...
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr
								+ '?__report=desco/procurement/ls_to_ss_requisition_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_REQUISITION_NO='
								+ param1;
