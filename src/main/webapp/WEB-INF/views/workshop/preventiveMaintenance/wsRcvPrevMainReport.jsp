...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"
				style="margin-top: 10px; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Preventive Transformer Receive Report</h1>
				<h3 class="center"
				style="margin-top: 10px; font-family: 'Ubuntu Condensed', sans-serif;">Your Transformer Receive Number is ${operationId}</h3>
	</div>
		...
		<div class="col-sm-12 table-responsive">
			...
			<div class="form-group col-xs-6">
				<%-- <div class="form-group col-xs-3">
					<label for="exampleInputName2">Receive Item No :</label>
				</div>
				<div class="col-xs-9">
					<input type="text" class="form-control" id="param1" name="param1"
						value="RS1220160500000001" style="width: 100%">
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr+ '?__report=desco/procurement/ws_rcv_preventive.rptdesign&__toolbar=false&__showtitle=false&__title=&P_NOTE_NO='+ param1;
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/ws_rcv_preventive.rptdesign&__toolbar=false&__showtitle=false&__title=&P_NOTE_NO='
				+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
