...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"
				style="margin-top: 10px; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Preventive Transformer Gate Pass Report</h1>
				<h3 class="center"
				style="margin-top: 10px; font-family: 'Ubuntu Condensed', sans-serif;">Your Gate Pass Number is ${gpNo}</h3>
	</div>
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr+ '?__report=desco/procurement/ws_prev_gatepass.rptdesign&__toolbar=false&__showtitle=false&__title=&P_GP_NO='+ param1;
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/ws_prev_gatepass.rptdesign&__toolbar=false&__showtitle=false&__title=&P_GP_NO='
				+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
