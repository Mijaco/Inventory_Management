...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/wsx_to_cs_return_slip.rptdesign&__toolbar=false&__showtitle=false&__title=&P_RS_NO='+ param1;
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/wsx_to_cs_return_slip.rptdesign&__toolbar=false&__showtitle=false&__title=&P_RS_NO='
				+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
