...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a href="${pageContext.request.contextPath}/wsx/returnSlip/wsTransformerReturnSlipForm.do"
				...
				<table id="returnSlipListTable"
					...
					<tbody>
						<c:forEach items="${returnSlipMstList}" var="returnSlipMst" varStatus="loop">
							<tr>
								<td>
								<form id="myForm${loop.index}" action="${pageContext.request.contextPath}/wsx/returnSlip/pageShow.do" method="POST">
