...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row"
		...
		<div class="oe_title">
			...
			<table class="col-sm-12 table">
				...
				<tr class="">
					...
					<td class="info bold"> <strong> ${currentStatus} </strong></td>
				</tr>
		...
		<div style="background: white;">
			...
			<div>
				<button class="btn btn-xs btn-success" id="checkboxallselect"><i class="fa fa-fw fa-check-square-o"></i>&nbsp;Select All</button>
				<button class="btn btn-xs btn-danger" id="checkboxdeleteselected"><i class="fa fa-fw fa-trash-o"></i>&nbsp;Delete All</button>
				<!-- 	added by nasrin	 -->		
					...
					<tbody>
						<c:forEach items="${jobCardDtlList}" var="jobCardDtl"
							...
							<tr>
								<td>
									<div class="checkbox">
										<label> <input type="checkbox" class="checkboxs" id="checkboxs${jobCardDtl.id}" value="${jobCardDtl.id}">
										</label>
									</div>
								</td>
