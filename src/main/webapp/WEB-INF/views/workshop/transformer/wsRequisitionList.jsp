...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<%-- <a
				href="${pageContext.request.contextPath}/ws/transformer/storeRequisitionForm.do"
		...
		<div class="col-sm-12 table-responsive">
			...
			<c:if test="${!empty centralStoreRequisitionMstList}">
				<%-- <div class="col-sm-6 pull-right">
					<form method="POST"
						action="${pageContext.request.contextPath}/ws/transformer/requisitionSearch.do">
						...
						<c:forEach items="${centralStoreRequisitionMstList}"
							...
							<tr>
								...
								<a
									...
									<c:out value="${centralStoreRequisitionMst.requisitionNo}" /></a>
											</td>
								<td><c:out
								...
								<td>
									<div class="action-buttons">
										<a class="btn btn-primary btn-xs" style="border-radius: 6px;"
											href="${pageContext.request.contextPath}/${centralStoreRequisitionMst.senderStore}/transformer/storeRequisitionShow.do?id=<str:decodeUrl>${centralStoreRequisitionMst.id}</str:decodeUrl>&&requisitionTo=<str:decodeUrl>${centralStoreRequisitionMst.requisitionTo}</str:decodeUrl>">
