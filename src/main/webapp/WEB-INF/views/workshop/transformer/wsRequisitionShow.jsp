...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a href="${pageContext.request.contextPath}/wsx/transformer/requisitionList.do"
	...
	<div class="row"
		...
		<div class="oe_title">
			...
			<table class="col-sm-12 table">
				...
				<tr class="">
					...
					<td class="info"><fmt:formatDate
						value="${representative.contractor.contractDate}" pattern="dd-MM-yyyy" /></td>
		...
		<!-- <script>
			...
			$.ajax({								
				url : '${pageContext.request.contextPath}/ss/itemEdit.do',
				data : "{id:"+id+"}",
	...
	function forwardToUpper(stateCode){
		...
		window.location = "${pageContext.request.contextPath}/wsx/transformer/requisition/sendTo.do?requisitionNo="+requisitionNo+"&justification="+justification+"&stateCode="+stateCode;
	}
	...
	function backToLower(stateCode){
		...
		var requisitionNo = $('#requisitionNo').val();		
		//window.location = "${pageContext.request.contextPath}/cs/itemRecieved/itemReceivedForwordTo.do?receivedReportNo="+param1+"$justification="+justification;
		window.location = "${pageContext.request.contextPath}/wsx/transformer/requisition/backTo.do?requisitionNo="+requisitionNo+"&justification="+justification+"&stateCode="+stateCode;
	}
	...
	function approveing(){		
		...
		window.location = "${pageContext.request.contextPath}/wsx/transformer/itemRequisitionSubmitApproved.do?requisitionNo="+requisitionNo+"&justification="+justification+"&return_state="+returnStateCode;
	}
