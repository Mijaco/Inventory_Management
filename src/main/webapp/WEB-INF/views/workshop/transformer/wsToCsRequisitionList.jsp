								...
								<td>
									<div class="action-buttons">
										<a class="btn btn-primary btn-xs" style="border-radius: 6px;"
											href="${pageContext.request.contextPath}/${centralStoreRequisitionMst.senderStore}/storeRequisitionShow.do?id=<str:decodeUrl>${centralStoreRequisitionMst.id}</str:decodeUrl>&&requisitionTo=<str:decodeUrl>${centralStoreRequisitionMst.requisitionTo}</str:decodeUrl>">
