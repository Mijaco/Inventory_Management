...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row" style="background-color: white; padding: 10px; padding-left: 20px; margin: 10px;">
		...
		<div class="col-sm-12 table-responsive">
			<c:if test="${empty cnWsCsRequisitionMstList}">
			...
			<c:if test="${!empty cnWsCsRequisitionMstList}">
				...
				<table id="cnPdRequisitionListTable"
					...
					<tbody>
						<c:forEach items="${cnWsCsRequisitionMstList}"
							var="cnWsCsRequisitionMst">
							<tr>
								<td><a
									href="${pageContext.request.contextPath}/cnws/showCnWsCsRequisition.do?id=${cnWsCsRequisitionMst.id}"
