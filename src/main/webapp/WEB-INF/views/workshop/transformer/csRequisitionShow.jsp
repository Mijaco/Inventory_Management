		...
		<div class="oe_title">
			...
			<table class="col-sm-12 table">
				...
				<tr class="">
					...
					<td class="info">
						<fmt:formatDate value="${representative.contractor.contractDate}" 
							pattern="dd-MM-yyyy" />
					</td>
				...
				<table id="requisitionListTable"
					...
					<tbody>
						<c:forEach items="${centralStoreRequisitionDtlList}"
							...
							<tr>
								<td><input type="hidden" class="reqDtlId" id="id${loop.index}" value="${centralStoreRequisitionDtl.id}" /><c:out value="${centralStoreRequisitionDtl.itemCode}" /></td>
...
<div id="myGrid" title="Title">
 ...
 <script
	src="${pageContext.request.contextPath}/resources/assets/js/workshop/wsCsXRequisitionShowAddedLocation.js"></script>
