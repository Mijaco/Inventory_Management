			...
			<table class="col-sm-12 table">
				<tr class="">
					<td class="success">Requisition No: <input type="hidden"
						...
						type="hidden" name="locationList" id="locationList"
						value=${locationList } /> <input type="hidden"
						name="ledgerBookList" id="ledgerBookList" value=${ledgerBookList } />
					</td>
				...
				<tr class="">
					...
					<td class="info">${centralStoreRequisitionMst.identerDesignation}</td>
					...
					<tbody>
						<c:forEach items="${centralStoreRequisitionDtlList}"
							...
							<tr>
								...
								<td><input type="hidden" class="reqDtlId"
									id="id${loop.index}" value="${centralStoreRequisitionDtl.id}" />
									<c:out value="${centralStoreRequisitionDtl.itemCode}" /></td>
					...
					<div class="dropup pull-right">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
							<c:forEach items="${nextManRcvProcs}" var="nextMan">
								<li class=""><a
									href="Javascript:forwardTo(${nextMan.stateCode})">For
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/workshop/wsCsRequisitionShowAddedLocation.js"></script>
