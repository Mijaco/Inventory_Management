...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a href="${pageContext.request.contextPath}/wsm/returnSlip/List.do"
	...
	<div class="row"
		...
		<!-- --------------------- -->
		<form method="POST"
			action="${pageContext.request.contextPath}/wsm/returnSlip/Save.do">
			<div class="oe_title">
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group">
						...
						<input type="hidden" name="workOrderNo" id="workOrderNumber"
								value="${contractNo}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="zone"
								value="X-Former Workshop" style="border: 0; border-bottom: 2px ridge;"
								name="zone">
						</div>
					</div>
													...
													<div class="aaa">
														...
														<div class="col-xs-12 entry" id="myArea0">
															<div class="row">
																...
																<div class="form-group col-sm-1 col-xs-12">
																	<input class="form-control uom" name="uom" type="text" id="unit0"
																...
																<div class="form-group col-sm-1 col-xs-12">
																	<input class="form-control unitCost" name="qtyUnServiceable"
																		type="number" id="unitCost0" step="0.01"
																		onblur="setTotalCost(this)" value="0"
																		style="border: 0; border-bottom: 2px ridge;" />
																</div>
																<div class="form-group col-sm-1 col-xs-12">
																	<input class="form-control totalCost" name="totalReturn" value="0"
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/workshop/transformerMaterials/wsToCsMaterialsReturnSlipForm.js"></script>
<!-- ------------------------------------Start of Footer-------------------------------------------------- -->
