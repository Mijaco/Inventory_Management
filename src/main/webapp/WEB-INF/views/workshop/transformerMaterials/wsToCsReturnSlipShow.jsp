...
<div class="row"
	...
	<script>
		...
		function forwardToUpper(stateCode) {
			...
			window.location = "${pageContext.request.contextPath}/wsm/returnSlip/sendTo.do?returnSlipNo="
					+ returnSlipNo
					+ "&justification="
					+ justification
					+ "&stateCode=" + stateCode;
		...
		function backToLower(stateCode) {
			...
			//window.location = "${pageContext.request.contextPath}/cs/itemRecieved/itemReceivedForwordTo.do?receivedReportNo="+param1+"$justification="+justification;
			window.location = "${pageContext.request.contextPath}/wsm/returnSlip/backTo.do?returnSlipNo="
					+ returnSlipNo
					+ "&justification="
					+ justification
					+ "&stateCode=" + stateCode;
		...
		function approveing() {
			...
			window.location = "${pageContext.request.contextPath}/wsm/returnSlip/itemReturnSlipApproved.do?returnSlipNo="
					+ returnSlipNo
					+ "&justification="
					+ justification
