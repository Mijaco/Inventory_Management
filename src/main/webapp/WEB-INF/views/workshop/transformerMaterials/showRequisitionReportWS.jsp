...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"
				style="margin-top: 10px; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Return
				Slip Report</h1>
	</div>
		...
		<div class="col-sm-12 table-responsive">
			...
			<div class="form-group col-xs-6">
				<div class="form-group col-xs-3">
					<label for="exampleInputName2">Return Slip No : ${operationId}</label>
				</div>
				<div class="col-xs-9">
					<input type="hidden" class="form-control" id="param1" name="param1"
						value="${operationId}" style="width: 100%">
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/wsm_to_cs_return_slip.rptdesign&__toolbar=false&__showtitle=false&__title=&P_RS_NO='+ param1;
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/wsm_to_cs_return_slip.rptdesign&__toolbar=false&__showtitle=false&__title=&P_RS_NO='
				+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
