					...
					<tbody>
						<c:forEach items="${asBuiltDtlList}"
							...
							<tr>
								...
								<td style="width:150px;"><input style="width:80px;"	type="number" step="0.001" value="${asBuiltDtl.materialsInHand}" name="materialsInHand" id="materialsInHand${loop.index}" readonly="readonly" /></td>
