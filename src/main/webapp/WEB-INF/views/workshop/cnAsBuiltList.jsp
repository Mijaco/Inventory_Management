...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a href="${pageContext.request.contextPath}/ws/asBuilt/asBuilt.do"
		...
		<div class="col-sm-12 table-responsive">
			<c:if test="${empty asBuiltMst}">
				<div class="col-sm-12 center">
					<h2 class="green">
						<i>Congratulation!!! You have no pending task on As Built
							Report. </i>
					</h2>
				</div>
			</c:if>
			...
			<c:if test="${!empty asBuiltMst}">
				...
				<table id="storeRequisitionListTable"
					...
					<tbody>
						<c:forEach items="${asBuiltMst}" var="asBuilt">
							<tr>
								<td><a
									href="${pageContext.request.contextPath}/ws/asBuilt/asBuiltShow.do?id=${asBuilt.id}"
									style="text-decoration: none;"><c:out
											value="${asBuilt.asBuiltNo}" /></a></td>
								<td><c:out value="${asBuilt.woNumber}" /></td>
								<td><fmt:formatDate value="${asBuilt.createdDate}"
