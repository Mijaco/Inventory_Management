...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row"
		...
		<form method="POST" enctype="multipart/form-data"
			action="${pageContext.request.contextPath}/ws/xf/saveWsContractor.do">
			...
			<div class="oe_title">
				<div class="col-md-6 col-sm-6">
						...
						<div class="col-sm-8">
							<div class="ui-widget">
								<input type="text" class="form-control" id="division"
									style="border: 0; border-bottom: 2px ridge;" value="Testing & Repairing"
									name="division" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<label for="address" class="col-sm-4 control-label">Project:&nbsp;<strong class='red'>*</strong></label>
						<div class="col-sm-8">
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group">
						<label for="expiryDate"
							class="col-sm-4 col-md-4 control-label align-right">Expire Date:&nbsp;<strong class='red'>*</strong></label>
						<div class="col-sm-8 col-md-8">
				...
				<div class="col-md-12 col-sm-12">
					<div class="form-group" style="margin-top: 1em;">
						<label for="fax" class="col-sm-4 control-label"
							style="font-style: italic; font-weight: bold;">Set Target for  Repair & Preventive Maintenance
							Target(s):</label>
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/workshop/wsContractorForm.js"></script>
<!-- ------------------------------------Start of Footer-------------------------------------------------- -->
