...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue">Total Transformer Receive Report <i> <b>   </b> </i>
		</h1>
...
<script type="text/javascript">
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/total_transformer_receive_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TRANSFORMER_TYPE='
