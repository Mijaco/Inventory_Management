...
<script type="text/javascript">
	...
	function query() {
		...
		var param2 = document.getElementById("contracNo").value;
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/workshop_work_progress.rptdesign&__toolbar=false&__showtitle=false&__title=&P_WORK_ORDER_NO='+param2+'&P_START_DATE='+param3+'&P_END_DATE='+param4;
	}
