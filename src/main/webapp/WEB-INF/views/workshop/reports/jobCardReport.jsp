...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue">Your Job Card Report <i> <b> ${operationId}  </b> </i>is ready.
		</h1>
		<div class="o_form_buttons_edit" style="display: block;">
			<input type="hidden" value="${operationId}" id="rrNo" /> <input type="text"
			...
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr
								+ '?__report=desco/procurement/job_card.rptdesign&__toolbar=false&__showtitle=false&__title=&P_JOB_CARD_NO='+ param1;
					});
</script>
<!-- -------------------------------------------------------------------------------------- -->
