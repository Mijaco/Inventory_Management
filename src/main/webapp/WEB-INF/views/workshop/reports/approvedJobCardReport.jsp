...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue">Your Job Card Report <i> <b> ${jobCardMst.jobCardNo}  </b> </i>is ready.
		</h1>
		<div class="o_form_buttons_edit" style="display: block;">
			<input type="hidden" value="${jobCardMst.jobCardNo}" id="jobCardNo" /> 
			<input type="hidden" value="${jobCardMst.version}" id="jobCardVersion" />
			<input type="text"
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						var param1 = document.getElementById("jobCardNo").value;
						var param2 = document.getElementById("jobCardVersion").value;
						...
						document.getElementById('requisitionReportFrame').src = birtAddr
								+ '?__report=desco/procurement/job_card_by_version.rptdesign&__toolbar=false&__showtitle=false&__title=&P_JOB_CARD_NO='+ param1+'&P_VERSION_NO='+ param2;
					});
</script>
<!-- -------------------------------------------------------------------------------------- -->
