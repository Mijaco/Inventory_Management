...
<script type="text/javascript">
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/total_transformer_bill_paid_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TRANSFORMER_TYPE='
