...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h2 class="center blue"
			...
			New LT-CT Meter Test Report Show</h2>
	...
	<div class="row"
		...
		<div class="table-responsive col-md-12 col-sm-12 col-xs-12">
			<table class="table table-bordered">
				<tbody>
					<tr>
						<td class="success col-md-2 text-right" style="font-weight: bold;">(i)
							Starting Test Report</td>
			...
			<table class="table table-bordered">
				<tbody>
					<tr>
						...
						<td>${meterTestingReport.dmfOfMeter}</td>
					</tr>
				</tbody>
			</table>
		</div>
