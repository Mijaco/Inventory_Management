				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td><input type="text" id="trackingNo" name="trackingNo" onblur="checkTrackingNo()"
								class="form-control" style="width: 100%">
								<h5 class="text-danger hide" id="tnerror"><strong>Invalid Tracking No.</strong></h5>
							</td>
			...
			<div class="table-responsive col-md-12 col-sm-12 col-xs-12">
				...
				<table class="table table-bordered">
					<tbody>
						...
						<tr>
							<td class="success col-md-3 text-right"
								style="font-weight: bold;">Accuracy Class:</td>
							<td class="col-md-3 col-sm-3 col-xs-3"><select
						...
						<tr>
							...
							<td><input type="text" id="meterType" name="meterType"
								readonly value="HTCT" class="form-control"
								style="width: 100%"></td>
							<td class="success col-md-3 text-right"
			...
			<div style="position: relative; margin-top: 10px !important;"
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							<td>Type/Model</td>
							<td><input type="text" id="ctTypeModelPhase1R" name="ctTypeModelPhase1R" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ctTypeModelPhase2Y" name="ctTypeModelPhase2Y" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ctTypeModelPhase3B" name="ctTypeModelPhase3B" class="form-control"
								style="width: 100%"></td>
						</tr>
						<tr>
							<td>CT Burden</td>
							<td><input type="text" id="ctBurdenPhase1R" name="ctBurdenPhase1R" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ctBurdenPhase2Y" name="ctBurdenPhase2Y" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ctBurdenPhase3B" name="ctBurdenPhase3B" class="form-control"
								style="width: 100%"></td>
						</tr>
						<tr>
							<td>Accuracy</td>
							<td><input type="text" id="ctAccuracyPhase1R" name="ctAccuracyPhase1R" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ctAccuracyPhase2Y" name="ctAccuracyPhase2Y" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ctAccuracyPhase3B" name="ctAccuracyPhase3B" class="form-control"
								style="width: 100%"></td>
						</tr>
						<tr>
							<td>CT Ratio</td>
							<td><input type="text" id="ctRatioPhase1R" name="ctRatioPhase1R" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ctRatioPhase2Y" name="ctRatioPhase2Y" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ctRatioPhase3B" name="ctRatioPhase3B" class="form-control"
								style="width: 100%"></td>
						</tr>
						<tr>
							<td>Megger Test Report</td>
							<td><select name="ctMeggerTestRptPhase1R" id="ctMeggerTestRptPhase1R" class="form-control"
								style="width: 100%;">
									<option value="PASSED">PASSED</option>
									<option value="FAILED">FAILED</option>
							</select></td>

							<td><select name="ctMeggerTestRptPhase2Y" id="ctMeggerTestRptPhase2Y" class="form-control"
								style="width: 100%;">
									<option value="PASSED">PASSED</option>
									<option value="FAILED">FAILED</option>
							</select></td>

							<td><select name="ctMeggerTestRptPhase3B" id="ctMeggerTestRptPhase3B" class="form-control"
								style="width: 100%;">
									<option value="PASSED">PASSED</option>
									<option value="FAILED">FAILED</option>
							</select></td>
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" id="ptBrandMfgNamePhase1R"
								name="ptBrandMfgNamePhase1R" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptBrandMfgNamePhase2Y"
								name="ptBrandMfgNamePhase2Y" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptBrandMfgNamePhase3B"
								name="ptBrandMfgNamePhase3B" class="form-control"
								style="width: 100%"></td>
						</tr>
						<tr>
							<td>Type/Model</td>
							<td><input type="text" id="ptTypeModelPhase1R" name="ptTypeModelPhase1R" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptTypeModelPhase2Y" name="ptTypeModelPhase2Y" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptTypeModelPhase3B" name="ptTypeModelPhase3B" class="form-control"
								style="width: 100%"></td>
						</tr>
						<tr>
							<td>PT Burden</td>
							<td><input type="text" id="ptBurdenPhase1R" name="ptBurdenPhase1R" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptBurdenPhase2Y" name="ptBurdenPhase2Y" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptBurdenPhase3B" name="ptBurdenPhase3B" class="form-control"
								style="width: 100%"></td>
						</tr>
						<tr>
							<td>Accuracy</td>
							<td><input type="text" id="ptAccuracyPhase1R" name="ptAccuracyPhase1R" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptAccuracyPhase2Y" name="ptAccuracyPhase2Y" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptAccuracyPhase3B" name="ptAccuracyPhase3B" class="form-control"
								style="width: 100%"></td>
						</tr>
						<tr>
							<td>pt Ratio</td>
							<td><input type="text" id="ptRatioPhase1R" name="ptRatioPhase1R" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptRatioPhase2Y" name="ptRatioPhase2Y" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptRatioPhase3B" name="ptRatioPhase3B" class="form-control"
								style="width: 100%"></td>
						</tr>
						<tr>
							<td>Megger Test Report</td>
							<td><select name="ptMeggerTestRptPhase1R" id="ptMeggerTestRptPhase1R" class="form-control"
								style="width: 100%;">
									<option value="PASSED">PASSED</option>
									<option value="FAILED">FAILED</option>
							</select></td>

							<td><select name="ptMeggerTestRptPhase2Y" id="ptMeggerTestRptPhase2Y" class="form-control"
								style="width: 100%;">
									<option value="PASSED">PASSED</option>
									<option value="FAILED">FAILED</option>
							</select></td>

							<td><select name="ptMeggerTestRptPhase3B" id="ptMeggerTestRptPhase3B" class="form-control"
								style="width: 100%;">
									<option value="PASSED">PASSED</option>
									<option value="FAILED">FAILED</option>
							</select></td>
					...
					<tbody>
						<tr>
							<td class="success col-md-3 text-right"
								...
								on CT &amp; PT</td>
							<td><textarea name="ctPtRemarks" id="ctPtRemarks" class="form-control">Name plate data ( Printed paper ) are attached on the body of CT and PT.</textarea>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td><input type="text" id="meterCTRatio" name="meterCTRatio" class="form-control"
								style="width: 100%"></td>
						</tr>
					</tbody>
				</table>
				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td><input type="text" id="meterPTRatio" name="meterPTRatio" class="form-control"
								style="width: 100%"></td>
						</tr>
					</tbody>
				</table>
				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td><input type="text" id="dmfOfMeter" name="dmfOfMeter" class="form-control"
								style="width: 100%"></td>
						</tr>
					</tbody>
				</table>
				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td><input type="text" id="omf" name="omf" class="form-control"
								style="width: 100%"></td>
						</tr>
					</tbody>
				</table>
					...
					<tbody>
						<tr>
							<td class="success col-md-3 text-right"
								...
								Remarks</td>
							<td><textarea name="overallRemarks" id="overallRemarks" class="form-control">Current Transformer (CT) and Potential Tranformer (PT) were tested from CERS, BPDB; report attached.</textarea>
							</td>
						</tr>
					</tbody>
				</table>
		...
		$.ajax({
			...
			success : function(data) {
				if( data == "success" ) { 
					...
					$('#tnerror').html("<strong>This field is required</strong>").removeClass('hide');
					saveButton.prop('disabled', true);
				} else {
					$('#tnerror').html("<strong>Tracking No. is used.</strong>").removeClass('hide');
					saveButton.prop('disabled', true);
				}
			},
			error : function(data) {
