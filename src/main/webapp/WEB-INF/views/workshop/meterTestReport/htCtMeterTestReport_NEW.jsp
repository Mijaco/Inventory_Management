...
/* added by taleb : editable select css start : http://jsfiddle.net/nwH8A/ */
.select-editable {
	position: relative;
			...
			<div style="position: relative; margin-top: 10px !important;"
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							<td>Type/Model</td>
							<td><input type="text" id="ptTypeModelPhase1R"
								name="ptTypeModelPhase1R" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptTypeModelPhase2Y"
								name="ptTypeModelPhase2Y" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptTypeModelPhase3B"
								name="ptTypeModelPhase3B" class="form-control"
								style="width: 100%"></td>
						</tr>
						<tr>
							<td>PT Burden</td>
							<td><input type="text" id="ptBurdenPhase1R"
								name="ptBurdenPhase1R" class="form-control" style="width: 100%"></td>
							<td><input type="text" id="ptBurdenPhase2Y"
								name="ptBurdenPhase2Y" class="form-control" style="width: 100%"></td>
							<td><input type="text" id="ptBurdenPhase3B"
								name="ptBurdenPhase3B" class="form-control" style="width: 100%"></td>
						</tr>
						<tr>
							<td>Accuracy</td>
							<td><input type="text" id="ptAccuracyPhase1R"
								name="ptAccuracyPhase1R" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptAccuracyPhase2Y"
								name="ptAccuracyPhase2Y" class="form-control"
								style="width: 100%"></td>
							<td><input type="text" id="ptAccuracyPhase3B"
								name="ptAccuracyPhase3B" class="form-control"
								style="width: 100%"></td>
						</tr>
						<tr>
							<td>pt Ratio</td>
							<td><input type="text" id="ptRatioPhase1R"
								name="ptRatioPhase1R" class="form-control" style="width: 100%"></td>
							<td><input type="text" id="ptRatioPhase2Y"
								name="ptRatioPhase2Y" class="form-control" style="width: 100%"></td>
							<td><input type="text" id="ptRatioPhase3B"
								name="ptRatioPhase3B" class="form-control" style="width: 100%"></td>
						</tr>
						<tr>
							<td>Megger Test Report</td>
				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td><input type="text" id="dmfOfMeter" name="dmfOfMeter"
								class="form-control" style="width: 100%"></td>
						</tr>
					</tbody>
				</table>
				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td><input type="text" id="omf" name="omf"
								class="form-control" style="width: 100%"></td>
						</tr>
					</tbody>
				</table>
