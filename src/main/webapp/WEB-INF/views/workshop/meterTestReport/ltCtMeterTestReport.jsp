...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h2 class="center blue"
			...
			New LT-CT Meter Test Report Form</h2>
	...
	<div class="row"
		...
		<form class="form-horizontal"
			...
			method="POST" id="ltCtMeterTestReportForm">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" id="meterType" name="meterType"
								readonly value="LTCT" class="form-control" style="width: 100%"></td>
							<td class="success col-md-3 text-right"
					...
					<tbody>
						<tr>
							...
							<td><textarea name="ctPtRemarks" id="ctPtRemarks"
									class="form-control">Name plate data are attached on the body of CT.</textarea>
							</td>
						</tr>
					</tbody>
				</table>
			...
			<div class="table-responsive col-md-12 col-sm-12 col-xs-12">
				<table class="table table-bordered">
					<tbody>
						<tr>
							<td class="success col-md-3 text-right"
								style="font-weight: bold; vertical-align: middle;">(G)
			...
			<div class="table-responsive col-md-12 col-sm-12 col-xs-12">
				<table class="table table-bordered">
					<tbody>
						<tr>
							<td class="success col-md-3 text-right"
								style="font-weight: bold; vertical-align: middle;">(I) Dial
			...
			<div class="table-responsive col-md-12 col-sm-12 col-xs-12">
				<table class="table table-bordered">
					<tbody>
						<tr>
							<td class="success col-md-3 text-right"
								style="font-weight: bold; vertical-align: middle;">(J)
