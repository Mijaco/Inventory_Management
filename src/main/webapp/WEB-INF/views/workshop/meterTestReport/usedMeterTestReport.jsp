...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h2 class="center blue"
			...
			Used (Old) Meter Test Report Form</h2>
	...
	<div class="row"
		...
		<form class="form-horizontal"
			...
			method="POST" id="usedMeterTestReportForm">
						...
						<tr>
							...
							<td><input type="hidden" id="meterType" name="meterType"
								...
								<select name="mType" id="mType" class="form-control">
									<option value="HTCT" selected>HTCT</option>
			...
			<div class="table-responsive col-md-12 col-sm-12 col-xs-12">
				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							<td class="success col-md-3 text-right"
								style="font-weight: bold;">(B) Meter, CT, PT &amp; Other
								Physical Observation:</td>
					...
					<tbody>
						<tr>
							<td class="col-md-3 success text-right"
								style="font-weight: bold;">(H) Seal Information</td>
							<td><textarea style="width: 100%" name="sealInfo"
									id="sealInfo">Comob box for the comments on existing seals of meter, TC, TTB, CTs, PTs &amp; Box etc.</textarea>
							</td>
						</tr>
					</tbody>
				</table>
