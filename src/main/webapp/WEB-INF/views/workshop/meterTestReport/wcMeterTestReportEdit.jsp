...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h2 class="center blue"
			...
			Whole Current Meter (New/Used) Test Report Show</h2>
	...
	<div class="row"
		...
		<form class="form-horizontal"
			...
			method="POST" id="wcMeterTestReportEditForm">
			<!-- MST Info :: start -->
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="hidden" id="meterType" name="meterType"
								...
								type="text" id="mType" name="mType" readonly
				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td><textarea style="width: 100%" name="sealInfo" id="sealInfo">${meterTestingReport.sealInfo}</textarea></td>
						</tr>
					</tbody>
				</table>
			</div>
					...
					<tbody>
						<tr>
							<td class="success col-md-3 text-right"
								...
								Remarks</td>
							<td><textarea id="overallRemarks" name="overallRemarks" class="form-control">${meterTestingReport.overallRemarks}</textarea></td>
						</tr>
					</tbody>
				</table>
			</div>
