		...
		<div class="">
			<table class="table table-bordered table-hover">
				...
				<tr>
					...
					<td class="col-xs-2"><select class="form-control" id="budgetTypeForBudget"
								name="budgetType" style="border: 0; border-bottom: 2px ridge;">
...
<script type="text/javascript">
	...
	function query() {
		...
		var param2 = $('#budgetTypeForBudget').val();
		
		if ($.trim(param1) == '' || param1 == null) {
			return;
		} else {
			document.getElementById('requisitionReportFrame').src = birtAddr
					+ '?__report=desco/procurement/budget_variance_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_DESCO_SESSION_ID='
