...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row"
		...
		<form method="POST" id="storeRequisitionFormSave"
			action="${pageContext.request.contextPath}/c2ls/storeRequisitionSave.do">
			<div class="oe_title">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="identerDesignation"
								value="${contractorRepresentative.contractor.contractorName} ( ${contractorRepresentative.contractNo} )"
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="receivedBy"
								value="${authUser.name}" style="border: 0; border-bottom: 2px ridge;"
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-8 col-md-8">
							...
							<select class="form-control category"
								name="requestedDeptId" id="requisitionTo"
								style="border: 0; border-bottom: 2px ridge;">
					...
					<%-- <div class="form-group">
						<label for="returnFor"
							...
							:</label>
						 <div class="col-sm-8 col-md-8">
							<select class="form-control category" readOnly="readOnly"
								name="khathId"
								style="border: 0; border-bottom: 2px ridge;">
								<!-- <option disabled selected>Category</option> -->
							...
							<div class="table">
								<div style="width: 1800px;">
									...
									<div class="col-xs-12">
										...
										<div class="form-group col-sm-1 col-xs-12">
											<b>Req. Qty&nbsp;<strong style="color: red;">*</strong></b>
										</div>
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/localStore/c2LsStoreRequisitionForm.js"></script>
<!-- ------------------------------------Start of Footer-------------------------------------------------- -->
