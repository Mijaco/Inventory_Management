													...
													<fieldset>
														...
														<div>
															<span class="block input-icon input-icon-right"> <select
																name="roleid" class="chosen-select form-control"
											...
											<thead>
												<tr role="row">
													<th class="sorting_asc" tabindex="0"
														aria-controls="dynamic-table2" rowspan="1" colspan="1"
														aria-sort="ascending"
														aria-label="user id: activate to sort column descending"
														style="width: 207px;">User Id</th>
													<th class="sorting" tabindex="0"
														aria-controls="dynamic-table2" rowspan="1" colspan="1"
														aria-label="Description: activate to sort column ascending"
														style="width: 296px;">Password</th>
													<th class="sorting" tabindex="0"
														aria-controls="dynamic-table2" rowspan="1" colspan="1"
														aria-label="Email: activate to sort column ascending"
														style="width: 378px;">Email</th>
													<th class="sorting" tabindex="0"
														aria-controls="dynamic-table2" rowspan="1" colspan="1"
														aria-label="Role: activate to sort column ascending"
														style="width: 183px;">Role</th>
													<th class="sorting" tabindex="0"
														aria-controls="dynamic-table2" rowspan="1" colspan="1"
														aria-label="Action: activate to sort column ascending"
														style="width: 202px;">Action</th>
												</tr>
											</thead>
											<tbody>
												...
												<c:forEach items="${permissionList}" var="permissions">
													<tr>
														...
														<c:choose>
															...
															<c:otherwise>
																<td><a class="btn btn-warning btn-xs" style="border-radius: 6px;"
