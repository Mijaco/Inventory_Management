...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			...
			<%-- <a href="#" class="btn btn-success btn-sm"
				onclick="postSubmit('${pageContext.request.contextPath}/adminpanel/userList.do',{role_id:'${role_id}'},'POST')">
					User(s) </a> --%>
	...
	<div class="row"
		...
		<!-- ------ Form Start ---------- -->
		<form method="POST"
			action="${pageContext.request.contextPath}/adminpanel/user/save.do">
			...
			<div class="oe_title">
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group">
						<label for="email"
							class="col-sm-4 col-md-4 control-label">Email</label>
