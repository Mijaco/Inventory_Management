	...
	<div id="navbar" class="navbar navbar-default" style="background-color: #A24689">
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="${pageContext.request.contextPath}/common.do" class="navbar-brand"> <small> <i
						class="glyphicon glyphicon-home"></i> ${properties['project.admin.panel']}
				</small>
				</a>
			</div>
...
<div class="" style="background-color: #A24689; padding: 15px; color: white" >
	<div class="center-block text-center">
		<div class="">
			<span class="bigger-60"> <span >&copy; 
					</span> 2015, DESCO. All rights reserved.
			</span> &nbsp; &nbsp; &nbsp; &nbsp;
			Design & Developed By <span> 
			<a href="http://www.ibcs-primax.com" target="_blank" style="color: white; text-decoration: none; font-style: italic;  font-weight: 500;">
