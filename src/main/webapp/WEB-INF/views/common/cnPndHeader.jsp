	...
	<div id="navbar" class="navbar navbar-default navbar-fixed-top"
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="${pageContext.request.contextPath}/common.do"
					class="navbar-brand"> <small> <i
						...
						${properties['project.contractor.pnd']}
				</small>
				</a>
			</div>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a
					href="${pageContext.request.contextPath}/template/jobTemplate.do">Cost
						Estimate Form</a>
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-haspopup="true"
					aria-expanded="false">List<span class="caret"></span></a>
					<ul class="dropdown-menu">
					<!-- commented by taleb instruction by alamin bhaia -->
						<%-- <li><a
							href="${pageContext.request.contextPath}/template/jobEstimationList.do">Cost
								Estimation (Pending approval) </a></li>
						<li>
						<li><a
							href="${pageContext.request.contextPath}/template/jobEstimationApprovedList.do">Cost
								Estimation </a></li> --%>
								
						<!-- added by taleb instruction by alamin bhaia -->
						<li><a
							href="${pageContext.request.contextPath}/template/pnd/jobEstimationList.do">Cost
								Estimation </a></li>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a
							href="${pageContext.request.contextPath}/pnd/costEstimationReport.do">Cost
								Estimation Report</a></li>
					</ul></li>
			</ul>
