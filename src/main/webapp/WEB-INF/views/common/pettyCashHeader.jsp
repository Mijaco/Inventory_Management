	...
	<div id="navbar" class="navbar navbar-default navbar-fixed-top"
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="${pageContext.request.contextPath}/pettycash.do"
					class="navbar-brand"> 
					<small>
						${properties['project.petty.cash']}
					</small>
				</a>
			</div>
			<ul class="nav navbar-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">	 
						<li><a
							href="${pageContext.request.contextPath}/pettycash/pettyCashHeadSetup.do">Petty Cash Head Entry Form</a></li>
						
						<li><a
							href="${pageContext.request.contextPath}/pettycash/pettyCashForm.do">Petty Cash Form</a></li>
					</ul></li>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu"> 
						<li><a
							href="${pageContext.request.contextPath}/pettycash/pettyCashHeadList.do">
								Petty Cash Head List </a></li>
						
						<li><a
							href="${pageContext.request.contextPath}/pettycash/pettyCashList.do">
								Petty Cash List </a></li>
						</ul></li>
