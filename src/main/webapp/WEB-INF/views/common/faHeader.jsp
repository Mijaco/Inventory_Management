		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="${pageContext.request.contextPath}/common.do"
					class="navbar-brand"> <small> <i
						...
						${properties['project.fixed.assets']}
				</small>
				</a>
			</div>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					aria-expanded="false">Fixed Asset Forms<span class="caret"></span></a>
					<ul class="dropdown-menu">
					 <li><a
							href="${pageContext.request.contextPath}/fixedAssets/fixedAssetForm.do">Fixed Asset (Without R.R.)
								</a></li>
								<li><a
							href="${pageContext.request.contextPath}/fixedAssets/stList.do">Fixed Asset (With R.R.)
								</a></li>
								<%-- <li><a
							href="${pageContext.request.contextPath}/fixedAssets/stList.do">Fixed Asset (From Local Purchase)
								</a></li> --%>
								 <li><a
							href="${pageContext.request.contextPath}/fixedAssets/accHeadForm.do">A/c Head Code Entry Form
								</a></li> <li><a
							href="${pageContext.request.contextPath}/fixedAssets/updateFixedAsset.do">Update Fixed Assets
								</a></li>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
<li><a
							href="${pageContext.request.contextPath}/fixedAssets/fixedAssetList.do">Fixed Assets List</a></li>
<li><a
							href="${pageContext.request.contextPath}/fixedAssets/depreciationSchedule.do">Asset Depreciation Schedule</a></li>
<li><a
							href="${pageContext.request.contextPath}/fixedAssets/depreciationCalc.do">Depreciation of Asset List</a></li>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
									      	<li><a href="${pageContext.request.contextPath}/report/assetPurchasedReport.do">Asset purchased report</a></li>	
									      	<li><a href="${pageContext.request.contextPath}/report/categoryWiseAssetReport.do">Category wise asset report</a></li>
									      	<li><a href="${pageContext.request.contextPath}/fixedAssets/categoryWiseDetailsAssetReport.do">Category wise asset Details Report</a></li>
									      	<li><a href="${pageContext.request.contextPath}/report/fixedAssetRegisterReport.do">Fixed asset register report</a></li>	
						<li><a href="${pageContext.request.contextPath}/fixedAssets/depreciationScheduleReport.do">Serial Number wise Depreciation Schedule Report</a></li>
									      	</ul></li>
			</ul>
