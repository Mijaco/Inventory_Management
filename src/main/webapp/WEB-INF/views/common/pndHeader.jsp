...
<div class="navbar-header pull-left">
				...
				<a href="${pageContext.request.contextPath}/common.do"
					class="navbar-brand"> <small> <i
						...
						${properties['project.contractor.pd']}
				</small>
				</a>
			</div>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<%-- <li><a
							href="${pageContext.request.contextPath}/cn/storeRequisitionForm.do">Store
								Requisiton</a></li>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-haspopup="true"
					aria-expanded="false">Archaives<span class="caret"></span></a>
					<ul class="dropdown-menu">
					...
					<%-- 	<li><a
						...
						<%-- <li><a
							href="${pageContext.request.contextPath}/pnd/job/finalList.do">Jobs</a></li>
							
						<li><a
							href="${pageContext.request.contextPath}/pnd/jobTemp/finalList.do">Job Templates</a></li> --%>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
								...
								<li><a
							href="${pageContext.request.contextPath}/template/jobEstimationList.do">Job Template
								</a></li>
						<li><a
							href="${pageContext.request.contextPath}/template/jobList.do">Job
								</a></li>

					</ul></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-haspopup="true"
					aria-expanded="false">Configure<span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a
							href="${pageContext.request.contextPath}/pnd/contractorForm.do">New Contractor</a></li>
						
						<li><a
							href="${pageContext.request.contextPath}/pnd/contractorRepresentiveForm.do">New Contractor
								Representive</a></li>
						<li><a
							href="${pageContext.request.contextPath}/template/jobTemplate.do">New Cost Estimattion</a></li>
						<li><a
							href="${pageContext.request.contextPath}/job/jobAssign.do">Assign Job To Contractor</a></li>
