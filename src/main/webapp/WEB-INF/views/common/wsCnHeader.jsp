			...
			<ul class="nav navbar-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<li><a
							href="${pageContext.request.contextPath}/ws/transformer/storeRequisitionForm.do">Store
								Requisiton</a></li>

						<li><a
							href="${pageContext.request.contextPath}/ws/transformer/returnSlip/getForm.do">Return
								Slip</a></li>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a
							href="${pageContext.request.contextPath}/ws/transformer/requisitionList.do">Store
								Transformer Requisiton</a></li>

						<li><a
							href="${pageContext.request.contextPath}/ws/transformer/returnSlip/List.do">Return
								Slip</a></li>								
						<li><a
							href="${pageContext.request.contextPath}/ws/transformer/storeTicketlist.do">Store
								Ticket List</a></li>
					</ul></li>
