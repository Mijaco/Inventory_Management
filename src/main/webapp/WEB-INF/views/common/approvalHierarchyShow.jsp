...
<!-- 			<button accesskey="D" class="btn btn-info btn-sm" type="button"> Discard </button> -->
			...
			<h1 class="center blue"><em> Approval Hierarchy Details </em></h1>
		...
		<!-- --------------------- -->
		<form method="POST" action="${pageContext.request.contextPath}/settings/update/department.do">
			<div class="oe_title">
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" class="form-control" id="stateName"
								value="${approvalHierarchy.stateName}" style="border: 0; border-bottom: 0px ridge;"
					...
					<div class="form-group">
						<label for="stateCode" class="col-sm-5 control-label" style="vertical-align: middle;"> State Code
							(Priority) </label>
						<div class="col-sm-7">
							<input type="text" class="form-control" id="stateCode"
								value="${approvalHierarchy.stateCode}" style="border: 0; border-bottom: 0px ridge;"
								name="stateCode" readonly/>							
						</div>
					</div>					
					...
					<div class="form-group">
						...
						style="vertical-align: middle;"> Role
							Name </label>
						<div class="col-sm-7 col-md-7">
							<input type="text" class="form-control" id="roleName" 
							value="${approvalHierarchy.roleName}"	style="border: 0; 
							border-bottom: 0px ridge;" name="roleName" readonly/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							...
							style="border: 0; border-bottom: 0px ridge;" name="operationName" readonly>
						</div>
					</div>
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group">
						...
						style="vertical-align: middle;"> created
							By </label>
						<div class="col-sm-7">
							<input type="text" class="form-control" id="createdBy"
								value="${approvalHierarchy.createdBy}" style="border: 0; 
								border-bottom: 0px ridge;" name="createdBy" readonly>
						</div>
					</div>
					...
					<div class="form-group">
						...
						Date </label>
						<div class="col-sm-7 col-md-7">
							<input type="datetime" class="form-control" value='<fmt:formatDate
	value="${approvalHierarchy.createdDate}" pattern="dd-MM-yyyy" />'
					...
					<div class="form-group">
						...
						style="vertical-align: middle;"> Last Modified 
							By </label>
						<div class="col-sm-7 col-md-7">
							<input type="email" class="form-control" value="${approvalHierarchy.modifiedBy}"
								id="modifiedBy" style="border: 0; border-bottom: 0px ridge;"
								name="modifiedBy" readonly />
						</div>
					</div>
					...
					<div class="form-group">
						...
						style="vertical-align: middle;"> Modified 
						Date </label>
						<div class="col-sm-7 col-md-7">
							<input type="datetime" class="form-control" value='<fmt:formatDate
					...
					<div class="form-group">
						...
						<div class="col-sm-7 col-md-7">
							...
							style="border: 0px ridge;" readonly>
								<c:out value="${approvalHierarchy.remarks}"/>
							</textarea>
						</div>
					</div>
