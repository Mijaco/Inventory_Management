	...
	<div id="navbar" class="navbar navbar-default navbar-fixed-top"
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="${pageContext.request.contextPath}/lprr.do"
					class="navbar-brand">
					<small>
							${properties['project.lprr']}
					</small>
				</a>
			</div>
			<ul class="nav navbar-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a
							href="${pageContext.request.contextPath}/settings/localPurchaseForm.do">Local
								Purchase Form</a></li>
					
						<li><a
							href="${pageContext.request.contextPath}/lrr/localReceivingReportForm.do">Local Receiving Report Form</a></li>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a
							href="${pageContext.request.contextPath}/settings/localPurchaseList.do">Local
								Purchase List </a></li>						
						<li><a
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu"> 
						<li><a
							href="${pageContext.request.contextPath}/report/query/localRecieveReport.do">Local RR</a></li>
					</ul></li>
