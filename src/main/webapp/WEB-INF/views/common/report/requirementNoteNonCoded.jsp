	...
	<div class="row"
		...
		<div class="text-right col-md-6">
			<h3
				...
				Requirement Report of Non-Coded Items for :</h3>
		</div>
	...
	function query() {
		...
		if ($.trim(param1) == '' || param1 == null) {
			...
			document.getElementById('requisitionReportFrame').src = birtAddr
					+ '?__report=desco/procurement/requirement_note_non_coded.rptdesign&__toolbar=false&__showtitle=false&__title=&P_SESSION_ID='
