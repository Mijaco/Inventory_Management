			...
			<ul class="nav navbar-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu" style="padding: 0px; margin: 0px;">
						<li><a
							href="${pageContext.request.contextPath}">Test</a></li>
					</ul></li>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu" style="padding: 0px; margin: 0px;">
						...
						<li><a
							href="${pageContext.request.contextPath}/cms/committee/contractList.do">
								CMS (In Process)</a></li>	
								
						<li><a
							href="${pageContext.request.contextPath}/app/committee/getAppPurchaseList.do">
