...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a href="${pageContext.request.contextPath}/ss/returnSlip/ListCS.do"
				style="text-decoration: none;" class="btn btn-primary btn-sm"> <span
				class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
				Return Slip List
			</a>
		</div>
		<h2 class="center blue" style="margin-top: 0; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Return Slip</h2>
		<h4 class="center blue" style="margin-top: 0; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">${department.deptName}</h4>
	</div>
		...
		<div class="oe_title">
			...
			<table class="col-sm-12 table">
				...
				<tr class="">					
					...
					<td class="info">
							${returnSlipMst.receiveFrom}, ${returnSlipMst.senderDeptName}</td>
							...
							<table id="requisitionListTable"
								...
								<thead>
									<tr
										...
										<td style="">Return Quantity <br /> (Recovery
											Serviceable)
										</td>
								...
								<tbody>
									<c:forEach items="${returnSlipDtlList}" var="returnSlipDtl"
										...
										<tr>
											...
											<td><input type="number" onblur="setTotalReturn(this)"
												value="${returnSlipDtl.qtyNewServiceable}"
												id="qtyNewServiceable${loop.index}" step="0.01"
												class="qtyNewServiceable" /></td>
											<td><input type="number" onblur="setTotalReturn(this)"
												value="${returnSlipDtl.qtyRecServiceable}"
												id="qtyRecServiceable${loop.index}" step="0.01"
												class="qtyRecServiceable" /></td>
											<td><input type="number" onblur="setTotalReturn(this)"
												value="${returnSlipDtl.qtyUnServiceable}"
												id="qtyUnServiceable${loop.index}" step="0.01"
												class="qtyUnServiceable" /></td>
											<td><input type="number"
												value="${returnSlipDtl.totalReturn}" step="0.01"
												class="totalReturn" readOnly="readOnly"
												id="totalReturn${loop.index}" /> <input type="hidden"
												value="${returnSlipDtl.id}" class="dtlId"
												readOnly="readOnly" id="dtlId${loop.index}" /></td>

											<td><c:out value="${returnSlipDtl.remarks}" /></td>
											<%-- <td>
												<div class="action-buttons" data-itemcode="${returnSlipDtl.itemCode}">
			
													<a href="#" class="btn btn-primary" id="setDialog${loop.index}"> <i
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/subStore/ssReturnSlipShow.js"></script>
<!-- ------------------------------------Start of Footer-------------------------------------------------- -->
