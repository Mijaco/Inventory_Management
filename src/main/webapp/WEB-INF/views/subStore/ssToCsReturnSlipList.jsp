...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<%-- <a
				href="${pageContext.request.contextPath}/${returnSlipMst.senderStore}/returnSlip/getForm.do"
...
<!-- 					<form method="POST" -->
<%-- 						action="${pageContext.request.contextPath}/${returnSlipMst.senderStore}/returnSlip/rsSearch.do"> --%>
					...
					<tbody>
						<c:forEach items="${returnSlipMstList}" var="returnSlipMst">
							<tr>
								<td>
									<c:choose>
										<c:when test="${returnSlipMst.senderStore == 'cn'}">
											<a
										...
										<c:otherwise>
											<a
												href="${pageContext.request.contextPath}/${returnSlipMst.senderStore}/returnSlip/pageShow.do?id=${returnSlipMst.id}"
												style="text-decoration: none;"><c:out
												value="${returnSlipMst.returnSlipNo}" /></a>
										</c:otherwise>
									</c:choose>
								...
								<td>
									<div class="action-buttons">
										...
										<a class="btn btn-primary btn-xs" style="border-radius: 6px;"
											href="${pageContext.request.contextPath}/ss/returnSlip/pageShow.do?id=${returnSlipMst.id}">
