		...
		<div class="oe_title">
			...
			<table class="col-sm-12 table">
				...
				<tr class="">
					...
					<td class="info"><fmt:formatDate
						value="${subStoreRequisitionMst.modifiedDate}" pattern="dd-MM-yyyy hh:mm:ss a" /></td>
...
<%-- 								<td><c:out value="${subStoreRequisitionDtl.totalCost}" /></td> --%>
	...
	function approveing(){
		if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
			...
			window.location = "${pageContext.request.contextPath}/ss/itemRequisitionSubmitApprovedLocalToSub.do?requisitionNo="+requisitionNo+"&justification="+justification+"&return_state="+returnStateCode;
		}
