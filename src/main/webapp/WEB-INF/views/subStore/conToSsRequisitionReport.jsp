...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"
			...
			To Sub Store Requisition Report</h1>
	</div>
		...
		<div class="col-sm-12 table-responsive">
			...
			<div class="form-group col-xs-6">
				<div class="form-group col-xs-3">
					<label for="exampleInputName2">Requisition No.</label>
				</div>
				<div class="col-xs-9">
					<input type="text" class="form-control" id="param1" name="param1"
						value="CN-SS-SR-2016-04-00000005" style="width: 100%"> <input
			...
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr
								+ '?__report=desco/procurement/con_to_ss_requisition_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_REQUISITION_NO='
								+ param1;
