...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row" style="background-color: white; padding: 10px; padding-left: 20px">
		...
		<div class="o_form_buttons_edit" style="display: block;">
			...
			<a href="${pageContext.request.contextPath}/ss/vehiclePermission.do"	
				...
				<table id="vehiclePermissionListTable"
					...
					<tbody>
						<c:forEach items="${vehiclePermissionList}" var="vehiclePermissionList">
							<tr>
								<td><a href="${pageContext.request.contextPath}/ss/showVehiclePermission.do?id=${vehiclePermissionList.id}" 
								...
								<td>
									<div class="action-buttons">
										...
										style="border-radius: 6px;"><i class="fa fa-edit"></i>&nbsp;Edit</a>
										<a class="btn btn-success btn-xs" href="${pageContext.request.contextPath}
										/ss/showVehiclePermission.do?id=${vehiclePermissionList.id}" style="border-radius: 6px;">
...
$(document).ready(
		function() {
			...
			document.getElementById(
					'vehiclePermissionListTable_length').style.display = 'none';
			document.getElementById(
					'vehiclePermissionListTable_filter').style.display = 'none';
		});
