	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/ls_to_ss_req_st.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TICKET_NO='+ param1;
