	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/cn_pd_ss_ret_st.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TICKET_NO='+ param1;
