		...
		<div class="col-sm-12 table-responsive">
			...
			<c:if test="${!empty csStoreTicketMstList}">
				<div class="col-sm-6 pull-right">
					<form method="POST" action="${pageContext.request.contextPath}/cs/itemRecieved/storeTicketSearch.do">
				...
				<table id="centralStorereceiveMstListTable"
					...
					<tbody>
						<c:forEach items="${csStoreTicketMstList}" var="csStoreTicketMst">
							<tr>
								<td><a
									href="${pageContext.request.contextPath}/ss/itemRecieved/openStoreTicket.do?operationId=${csStoreTicketMst.operationId}&flag=${csStoreTicketMst.flag}&storeTicketType=${csStoreTicketMst.storeTicketType}&ticketNo=${csStoreTicketMst.ticketNo}"
