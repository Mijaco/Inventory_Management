...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h4 class="center blue col-md-offset-3 col-md-6"
			...
			Return Slip No:&nbsp;&nbsp;<input type="text" id="param1" name="param1"
						style="width: 40%"> 
	...
	/* $(document)
			.ready(
					function() {
						...
						document.getElementById('rsReportFrame').src = birtAddr	+ '?__report=desco/procurement/ls_to_ss_return_slip_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_RETURN_SLIP_NO='+ param1;
