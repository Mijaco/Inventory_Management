...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"><i> <b> ${operationId}  </b> </i></h1>
			...
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr
								+ '?__report=desco/procurement/cn_to_ss_store_requisition.rptdesign&__toolbar=false&__showtitle=false&__title=&P_REQUISITION_NO='+ param1;
					});
</script>
<!-- -------------------------------------------------------------------------------------- -->
