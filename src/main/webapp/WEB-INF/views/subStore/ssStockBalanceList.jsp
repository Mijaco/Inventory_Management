...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row"
		...
		<div class="col-sm-12 table-responsive">
			<c:if test="${empty ssItemTransactionMstList}">
			...
			<c:if test="${!empty ssItemTransactionMstList}">
				<div class="col-sm-10 pull-right">
					<form method="POST"
						action="${pageContext.request.contextPath}/ss/ledger/balanceSearch.do">
				...
				<table id="itemLedgerListTable"
					...
					<tbody>
						<c:forEach items="${ssItemTransactionMstList}"
							var="ssItemTransactionMst">

							<tr>
								<td><a
									href="${pageContext.request.contextPath}/ss/ledger/itmTnxLedger.do?id=${ssItemTransactionMst.id}"
									style="text-decoration: none;"><c:out
											value="${ssItemTransactionMst.itemCode}" /></a></td>

								<td><c:out value="${ssItemTransactionMst.itemMaster.itemName}" /></td>
								<td><c:out value="${ssItemTransactionMst.itemMaster.unitCode}" /></td>

								<td><c:out value="${ssItemTransactionMst.khathName}" /></td>

								<td><c:out value="${ssItemTransactionMst.ledgerName}" /></td>
								...
								<td><c:out value="${ssItemTransactionMst.safetyMargin}" /></td>
								<td>
