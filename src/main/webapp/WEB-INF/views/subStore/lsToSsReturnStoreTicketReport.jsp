...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/ls_to_ss_return_store_ticket.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TICKET_NO='+ param1;
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/ls_to_ss_return_store_ticket.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TICKET_NO='
				+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
