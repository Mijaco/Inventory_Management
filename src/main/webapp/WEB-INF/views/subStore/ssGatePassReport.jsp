	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/ls_to_cs_gate_pass_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_GATE_PASS_NO='+ param1;
