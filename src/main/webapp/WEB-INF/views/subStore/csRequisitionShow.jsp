		...
		<div class="oe_title">
			...
			<table class="col-sm-12 table">
				...
				<tr class="">
					...
					<td class="info">${centralStoreRequisitionMst.receivedBy}</td>
				...
				<table id="requisitionListTable"
					...
					<thead>
						<tr
							...
							<td style="">Unit</td>
							<td>Current Stock (NS)</td>
							<td>Current Stock (RS)</td>
						...
						<c:forEach items="${centralStoreRequisitionDtlList}"
							...
							<tr>
								...
								<td><input class="issuedQty" type="number"
									...
									name="issuedQty"
									value="${centralStoreRequisitionDtl.quantityIssued}" step="0.001"/></td>
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 text-center">
				<a class="btn btn-primary"
					href="Javascript:approveSubCsRequisition()"
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/subStore/csSsRequisitionShowAddedLocation.js"></script>
