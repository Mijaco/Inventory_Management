...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"
				style="margin-top: 10px; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Sub Store
				To Central Store Return Slip Report</h1>
	</div>
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/ss_to_cs_return_slip_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_RETURN_SLIP_NO='+ param1;
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/ss_to_cs_return_slip_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_RETURN_SLIP_NO='
				+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
