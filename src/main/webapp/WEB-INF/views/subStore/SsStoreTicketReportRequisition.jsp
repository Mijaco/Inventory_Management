		...
		<div class="col-xs-4">
			<c:if test="${!empty multipleGPNoList}">	
				...
				<c:forEach items="${multipleGPNoList}" var="gatePassNo">
					<a 	href="${pageContext.request.contextPath}/ss/gatePassGenerate.do?gatePassNo=${gatePassNo}"
					target="_blank">
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/ls_to_sub_store_ticket_issue_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TICKET_NO='+ param1;
