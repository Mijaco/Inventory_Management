...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"
				...
				To Central Store Return	Store Ticket Report</h1>
	</div>
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/ss_to_cs_return_store_ticket.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TICKET_NO='+ param1;
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/ss_to_cs_return_store_ticket.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TICKET_NO='
				+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
