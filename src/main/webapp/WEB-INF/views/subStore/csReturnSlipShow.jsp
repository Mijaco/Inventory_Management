...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue" style="margin-top: 0px;">Return Slip</h1>
	</div>
				...
				<table id="requisitionListTable"
					...
					<thead>
						<tr
							...
							<td style="">Unit</td>
							<td style="">Return Quantity</td>
							<td style="">Serviceable Quantity</td>
							<td style="">Repairable  Quantity</td>
							<td style="">Non-Repairable  Quantity</td>
					...
					<tbody>
						<c:forEach items="${returnSlipDtlList}" var="returnSlipDtl">
							<tr>
								...
								<td><c:out value="${returnSlipDtl.qtyServiceable}" /></td>
								<td><c:out value="${returnSlipDtl.qtyRepairable}" /></td>
								<td><c:out value="${returnSlipDtl.qtyNonRepairable}" /></td>
								<td><c:out value="${returnSlipDtl.totalReceived}" /></td>
	...
	function forwardToUpper(stateCode){
		...
		window.location = "${pageContext.request.contextPath}/ss/returnSlip/sendTo.do?returnSlipNo="+returnSlipNo+"&justification="+justification+"&stateCode="+stateCode;
	}
	...
	function backToLower(stateCode){
		...
		//window.location = "${pageContext.request.contextPath}/cs/itemRecieved/itemReceivedForwordTo.do?receivedReportNo="+param1+"$justification="+justification;
		window.location = "${pageContext.request.contextPath}/ss/returnSlip/backTo.do?returnSlipNo="+returnSlipNo+"&justification="+justification+"&stateCode="+stateCode;
	}
	...
	function approveing(){		
		...
		window.location = "${pageContext.request.contextPath}/ss/itemReturnSlipApproved.do?returnSlipNo="+returnSlipNo+"&justification="+justification+"&return_state="+returnStateCode;
	}
</script>
	</div>
</div>
