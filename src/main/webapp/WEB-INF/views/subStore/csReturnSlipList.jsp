...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<%-- <a
				href="${pageContext.request.contextPath}/ls/returnSlip/getForm.do"
		...
		<div class="col-sm-12 table-responsive">
			...
			<c:if test="${!empty returnSlipMstList}">
				<div class="col-sm-6 pull-right">
					<form method="POST"
						action="${pageContext.request.contextPath}/ss/returnSlip/rsSearch.do">
	...
	$(document)
			.ready(
					function() {
						...
						document
								.getElementById('returnSlipListTable_filter').style.display = 'none';
