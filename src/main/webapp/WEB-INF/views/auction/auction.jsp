...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h2 class="center blue ubuntu-font">
			<em>Welcome to Auction Process</em>
		</h2>
		...
		<div class="row">
			<div class="col-sm-4  col-sm-offset-4"
				...
				<div class="col-sm-12 center">
					<h1 class="red center italicized">
						<em>Pending Task</em>
					</h1>
					...
					<a
						...
						style="display: block; margin-bottom: 10px; border-radius: 8px;">Item
						...
						class="btn btn-primary"
						style="display: block; margin-bottom: 10px; border-radius: 8px;">Store
