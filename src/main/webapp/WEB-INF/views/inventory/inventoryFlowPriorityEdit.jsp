...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row"
		...
		<!-- --------------------- -->
		<form method="POST"
			action="${pageContext.request.contextPath}/inventory/inventoryFlowPriorityUpdate.do">
			<div class="oe_title">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="stateName"
								...
								value="${inventoryFlowPriority.stateName}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="priority"
								value="${inventoryFlowPriority.priority}" placeholder="100"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" id="roleName"
								...
								<option selected>${inventoryFlowPriority.roleName}</option>
				...
				<div class="col-md-12">
					...
					<div class="form-group col-sm-12">
						<textarea rows="3" cols="" id="remarks" class="form-control"
							maxlength="1000" name="remarks">${inventoryFlowPriority.remarks}</textarea>
					</div>
				...
				<div class="col-md-12">
					...
					<div class="form-group col-sm-10">
						<c:if test="${inventoryFlowPriority.active eq true}">
							<input type="checkbox" checked name="active" id="active" />
						</c:if>
						<c:if test="${inventoryFlowPriority.active eq false}">
					...
					<input type="hidden" class="form-control" id="modifiedBy"
						...
						id="porcid" value='${inventoryFlowPriority.id}' name="id" />
				</div>
				<div class="col-md-12">
