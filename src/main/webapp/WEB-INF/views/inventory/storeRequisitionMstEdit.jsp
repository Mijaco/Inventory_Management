...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a
				href="${pageContext.request.contextPath}/inventory/storeRequisitionShow.do"
	...
	<div class="row"
		...
		<div class="oe_title">
			<form method="POST" class=""
				action="${pageContext.request.contextPath}/inventory/requuisitionMasterUpdate.do">
				...
				<div class="col-md-12">
					...
					<div class="form-group col-sm-12">
						<textarea rows="3" id="justification" class="form-control"
							maxlength="1000" name="justification">${storeRequisitionMst.justification}</textarea>
					</div>
					<input type="text" value="${storeRequisitionMst.id}" hidden="true"
						name="id" />
