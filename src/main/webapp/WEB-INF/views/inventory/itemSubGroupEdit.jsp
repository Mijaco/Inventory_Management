...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a
				...
				href="${pageContext.request.contextPath}/inventory/showItemSubGroup.do?itemSubGroupId=${selectItemSubGroup.itemSubGroupId}"
	...
	<div class="row"
		...
		<form:form method="POST"
			action="${pageContext.request.contextPath}/inventory/itemSubGroupUpdate.do"
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" class="form-control"
									style="border: 0; border-bottom: 2px ridge;"
									path="itemSubGroupName" name="itemSubGroupName"
