	...
	<div class="container-fluid icon-box"
		...
		<div class="row"
			...
			<div class="o_form_buttons_edit" style="display: block;">
				<a href="${pageContext.request.contextPath}/inventory/list.do"
		...
		<div class="container-fluid icon-box"
			...
			<div class="row"
				...
				<form:form method="POST"
					...
					commandName="itemGroup">
					<div class="oe_title">

						<form:input class="o_form_input o_form_field o_form_required"
							placeholder="Name" type="text" name="itemGroupName"
							path="itemGroupName"
							style="border: 0; border-bottom: 2px ridge; width: 60%; font-size: 2em" />

						<form:input class="o_form_input o_form_field o_form_required"
							id="company" placeholder="Activate or Not" type="text"
							name="itemGroupIsActive" path="itemGroupIsActive"
