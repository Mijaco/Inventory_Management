			...
			<div class="col-md-12 col-sm-12">
				<table class="col-md-12 col-sm-12 table-bordered">
					<tr>
						...
						<td class="col-md-9 col-sm-9">${procurementFlowPriority.stateName}</td>
					</tr>
					<tr>
						<th class="col-md-2 col-sm-2">Priority</th>
						<td class="col-md-1 col-sm-1">:</td>
						<td class="col-md-9 col-sm-9">${procurementFlowPriority.priority}</td>
					</tr>
					<tr>
						<th class="col-md-2 col-sm-2">Role Name</th>
						<td class="col-md-1 col-sm-1">:</td>
						<td class="col-md-9 col-sm-9">${procurementFlowPriority.roleName}</td>
					</tr>
					<tr>
						<th class="col-md-2 col-sm-2">Is Active ?</th>
						<td class="col-md-1 col-sm-1">:</td>
						<td class="col-md-9 col-sm-9">
						<c:if test="${procurementFlowPriority.active eq true}">Yes</c:if>
						<c:if test="${procurementFlowPriority.active eq false}">No</c:if>
						</td>
					</tr>
					<tr>
						<th class="col-md-2 col-sm-2">Comments</th>
						<td class="col-md-1 col-sm-1">:</td>
						<td class="col-md-9 col-sm-9">${procurementFlowPriority.remarks}</td>
					</tr>
					<tr>
						<th class="col-md-2 col-sm-2">Created By</th>
						<td class="col-md-1 col-sm-1">:</td>
						<td class="col-md-9 col-sm-9">${procurementFlowPriority.createdBy}</td>
					</tr>
					<tr>
						<th class="col-md-2 col-sm-2">Created Date</th>
						<td class="col-md-1 col-sm-1">:</td>
						<td class="col-md-9 col-sm-9"><fmt:formatDate
							value="${procurementFlowPriority.createdDate}" pattern="dd-MM-yyyy" /></td>
					</tr>
					<tr>
						<th class="col-md-2 col-sm-2">Modified By</th>
						<td class="col-md-1 col-sm-1">:</td>
						<td class="col-md-9 col-sm-9">${procurementFlowPriority.modifiedBy}</td>
					</tr>
					<tr>
						<th class="col-md-2 col-sm-2">Modified Date</th>
						<td class="col-md-1 col-sm-1">:</td>
						<td class="col-md-9 col-sm-9"><fmt:formatDate
							value="${procurementFlowPriority.modifiedDate}" pattern="dd-MM-yyyy" /></td>
					</tr>
				</table>
			</div>
		</div>
