...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a href="${pageContext.request.contextPath}/getAllocationForm.do"
				style="text-decoration: none;" class="btn btn-primary btn-sm">
				Back to Allocation Form </a>
		</div>
		...
		<form
			...
			<div class="hidden">
				<input type="hidden" name="descoSessionId"
					value="${descoSession.id}" /> <input type="hidden" name="deptId"
					value="${department.deptId}" /> <input id="contextPath"
					...
					<table id="allocationTable"
						...
						<tbody>
							<c:forEach items="${allocationTableList}" var="allocationTable"
								varStatus="loop">
								<tr>
									<td><c:out value="${allocationTable.itemCode}" /> <input
										type="hidden" name="allocationId"
										value="${allocationTable.id}" /></td>
									<td><c:out value="${allocationTable.itemName}" /></td>
									<td class="center"><c:out value="${allocationTable.uom}" /></td>
									...
									</select> <%-- <input type="checkbox" name="unlimitedReq"
										checked="checked" value="${allocationTable.unlimited}"/> --%>
									...
									<td class="center"><c:out
											value="${allocationTable.usedQuantity}" /></td>
									<td><a href="#"
