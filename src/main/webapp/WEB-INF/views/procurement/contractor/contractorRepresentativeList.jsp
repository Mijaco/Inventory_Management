...
<div class="modal fade" tabindex="-1" role="dialog" id="representativeModal">
  <div class="vertical-alignment-helper">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form action="${pageContext.request.contextPath}/proc/saveProcMultipleRepresentativeInfo.do" method="POST" id="saveMultipleFormData"
...
<script src="${pageContext.request.contextPath}/resources/assets/js/contractor/contractorRepresentativeList.js"></script>
...
<script>
	...
	function updateAction( eq ) {
		...
		$.ajax({
			url : baseURL + "/proc/updateRepresentativeInfo.do",
