						...
						<tbody>
							...
							<tr>
								...
								<td class="col-xs-4"><input type="text"
									name="psiAcceptanceDate" id="psiAcceptanceDate"
									class="datepicker-15"
							...
							<tr>
								...
								<td class="col-xs-10" colspan="3"><textarea
										name="psiAcceptanceRemarks" id="psiAcceptanceRemarks"
										required="required" style="width: 100%"></textarea></td>
									...
									id="sendFor" required="required">
										...
										<c:if test="${!empty approvalHierarchyList}">
											<c:forEach items="${approvalHierarchyList}"
												...
												<c:if test="${approvalHierarchy.stateCode!='500'}">
