					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								...
								<td class="col-xs-4"><input type="text" name="chalanNo"
									id="chalanNo"
							...
							<tr>
								<td class="col-xs-2 success">Goods Received Date</td>
								<td class="col-xs-4"><input type="text"
									name="goodsReceivedDate"
									style="width: 100%; border: 0; border-bottom: 2px ridge;"
									id="goodsReceivedDate" class="datepicker-15"></td>

								<td class="col-xs-2 success">Remarks</td>
								<td class="col-xs-4"><textarea name="goodsReceivedRemarks"
										id="goodsReceivedRemarks" style="width: 100%"></textarea></td>
									...
									id="sendFor" required="required">
										...
										<c:if test="${!empty approvalHierarchyList}">
											<c:forEach items="${approvalHierarchyList}"
												...
												<c:if test="${approvalHierarchy.stateCode!='600'}">
