						...
						<c:forEach items="${contractManagementList}"
							...
							<tr>
								<td><a href="javascript:void(0)" class="blue"
									onclick="view(${contractManagement.id})">${contractManagement.contractNo}
								</a></td>
								<td><fmt:formatDate
								...
								<td>
									<div class="action-buttons center">
										<button class="btn btn-primary btn-xs"
											onclick="view(${contractManagement.id})"
											style="border-radius: 4px;" id="contractManagement">
											<i class="fa fa-fw fa-info"></i>&nbsp;Payment Info
										</button>
									</div>
								</td>
							</tr>
...
<script type="text/javascript">
	...
	function view(id) {			
		...
		var cData = {"id" : id}
		var path=contextPath+'/cms/contractArchiveShow.do';	
