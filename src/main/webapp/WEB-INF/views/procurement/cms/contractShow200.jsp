				...
				<form
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								<td class="col-xs-2 success">Approval Date</td>
								<td class="col-xs-4"><input type="text" required="required"
									name="drwApprovalDate" class="datepicker-15 form-control" /></td>
								<td class="col-xs-2 success">Approval Copy</td>
								<td class="col-xs-4">
									<%-- ${cms.drwApprovalCopy} --%> <input class="form-control"
									accept="application/pdf" type="file" name="refDoc">
							...
							<tr>
								...
								<td class="col-xs-10" colspan="3">
									<textarea class="form-control" rows="" required="required" name="drwApprovalRemarks"></textarea>
								</td>
									...
									id="sendFor" required="required">
										...
										<c:if test="${!empty approvalHierarchyList}">
											<c:forEach items="${approvalHierarchyList}"
												...
												<c:if test="${approvalHierarchy.stateCode!='200'}">
