			...
			<table class="table table-bordered">
				<tbody>
					...
					<tr>
						...
						<td class="col-xs-4 info">${cms.goodsReceivedDate}</td>
						<td class="col-xs-2 success">Remarks</td>
						<td class="col-xs-4 info">${cms.goodsReceivedRemarks}</td>
					</tr>
				...
				<form
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								<td class="col-xs-2 success">Report Date</td>
								<td class="col-xs-4"><input type="text"
									name="pliReportDate" id="pliReportDate" class="datepicker-15"
									style="width: 100%; border: 0; border-bottom: 2px ridge;"
									required="required"></td>
								<td class="col-xs-2 success">Report Copy</td>
							...
							<tr>
								...
								<td class="col-xs-10" colspan="3"><textarea
										name="pliReportRemarks" id="pliReportRemarks"
									...
									id="sendFor" required="required">
										...
										<c:if test="${!empty approvalHierarchyList}">
											<c:forEach items="${approvalHierarchyList}"
												...
												<c:if test="${approvalHierarchy.stateCode!='700'}">
