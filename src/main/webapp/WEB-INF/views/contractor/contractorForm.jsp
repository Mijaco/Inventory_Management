...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row"
		...
		<form method="POST" enctype="multipart/form-data"
			action="${pageContext.request.contextPath}/pnd/contractorSave.do">
			...
			<div class="oe_title">
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group">
						<label for="tenderNo" class="col-sm-4 control-label">Tender
							No:&nbsp;<strong class='red'>*</strong></label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label">Division/Area :</label>
						<div class="col-sm-8">
							<div class="ui-widget">
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="col-sm-10 col-md-9">&nbsp;&nbsp;</div> -->
					<div class="form-group">
						<label class="col-sm-4 control-label align-right">Remarks
							:</label>
						<div class="col-sm-8">
