...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row"
		...
		<!-- --------------------- -->
		<form method="POST"
			action="${pageContext.request.contextPath}/job/jobAssignSave.do">
			<div class="oe_title">
			<!-- -------start--------- -->
				<div class="col-md-6">
					...
					<div class="form-group">
						<label for="name" class="col-sm-4 control-label">Applicant Name
							&amp; Address:&nbsp;<strong class='red'>*</strong></label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="typeOfScheme" class="col-sm-4 control-label">Type
							Of Scheme:&nbsp;<strong class='red'>*</strong></label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="pdNo" class="col-sm-4 control-label">Project/P&amp;D Ref.:&nbsp;<strong class='red'>*</strong></label>
						<div class="col-sm-8">
