...
<div class="container-fluid icon-box" style="background-color: #858585;">
					...
					<tbody>
						<c:forEach items="${subStoreRequisitionDtlList}" var="subStoreRequisitionDtl">
							<tr>
								...
								<td><input type="text" name="issueqty" id=issueqty value="<c:out value="${subStoreRequisitionDtl.quantityIssued}" />"><input type="text" name="ids" value="<c:out value="${subStoreRequisitionDtl.id}" />"></td>
	...
	function approveing(){		
		...
		window.location = "${pageContext.request.contextPath}/cn/itemRequisitionSubmitApproved.do?requisitionNo="+requisitionNo+"&justification="+justification+"&return_state="+returnStateCode+"&issueqty="+issueqty;
	}
</script>
	</div>
</div>
