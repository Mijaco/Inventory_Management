...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a href="${pageContext.request.contextPath}/cnpd/cnPdRequisitionList.do" style="text-decoration: none;"
				class="btn btn-primary btn-sm"> <span
				class="glyphicon glyphicon-th-list" aria-hidden="true"></span>Requisition
				List
			</a>
		</div>		
			<h2 class="center blue" style="margin-top: 5px; font-style: italic; 
			font-family: 'Ubuntu Condensed', sans-serif;">Store	Requisition</h2>
	</div>
...
<%-- 								<td><c:out value="${cnReqDtl.totalCost}" /></td> --%>
		...
		<!-- removed by taleb instruction by alamin -->
		<%-- <div class="row">
				...
				<c:if test="${empty nextManRcvProcs1}">
					<div class="pull-left" style="margin-left: 25px;">
						<button type="button" class="btn btn-primary" id="approveButton"
							onclick="approveCnPdStoreRequisition()"
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/contractor/showPdRequisition.js"></script>
