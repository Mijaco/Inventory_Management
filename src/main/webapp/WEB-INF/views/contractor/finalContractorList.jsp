...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a
				href="${pageContext.request.contextPath}/pnd/contractorForm.do"
										...
										<tr>
											...
											<td>
												...
												<p class="hide" id="updateaddress${loop.index}">
													<input type="text" style="width: 100%; margin-left: 0 !important" class="form-control"
														id="uAddress${loop.index}" value="${contractor.address}">
												</p>
											</td>
											...
											<td><a href="#" class="blue"
												onclick="postSubmit('${pageContext.request.contextPath}/jobs/finalList.do',{id:'${contractor.id}'},'POST')">
													Job(s) </a></td>
											<td> <a class="btn btn-primary btn-xs" id="editButton${loop.index}" onclick="editThis(${loop.index})" style="border-radius: 6px;"
													href="javascript:void(0)"> <i class="fa fa-fw fa-edit"></i>&nbsp;Edit
												</a>
												
												<a class="btn btn-success btn-xs hide" id="updateButton${loop.index}" onclick="updateData(${contractor.id}, ${loop.index})" style="border-radius: 6px;"
													href="javascript:void(0)"> <i class="fa fa-fw fa-repeat"></i>&nbsp;Update
												</a>
											</td>
										</tr>
									</c:forEach>
