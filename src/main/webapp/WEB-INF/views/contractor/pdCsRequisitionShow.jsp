	...
	<div class="row"
		...
		<div class="oe_title">
			...
			<table class="col-sm-12 table">
				<tr class="">
					...
					<td class="info">
						<fmt:formatDate
							value="${centralStoreRequisitionMst.createdDate}" pattern="dd-MM-yyyy hh:mm:ss a" />
					</td>
					
					<td class="success">Project Name:</td>
					<td class="info"><strong> ${centralStoreRequisitionMst.khathName} </strong></td>
				...
				<tr class="">
					...
					<td class="success">Work Order:</td>
					<td class="info">${centralStoreRequisitionMst.workOrderNumber}
					</td>
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 text-center">
				...
				<a class="btn btn-danger" href="Javascript:rejectProcess()"
					style="text-decoration: none; border-radius: 6px;">
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/contractor/pdCsRequisitionShow.js"></script>
<!-- ------------------------------------Start of Footer-------------------------------------------------- -->
