...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	function approveing(){
		if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
			...
			window.location = "${pageContext.request.contextPath}/cn/itemReturnSlipApprovedCn.do?returnSlipNo="+returnSlipNo+"&justification="+justification+"&return_state="+returnStateCode;
		}
	}
	...
	function forwardToUpper1(stateCode, userid) {
		if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
			...
			var path=contextPath+"/cn/sendToCnPdReturn.do";	
	...
	function backToLower1(stateCode, userid) {
		if( $('#justification').val() == null || $.trim( $('#justification').val() ) == '' ) {
			...
			var path=contextPath+"/cn/backToCnPdReturn.do";	
			postSubmit(path, cData, 'POST');
		}
	}
</script>
