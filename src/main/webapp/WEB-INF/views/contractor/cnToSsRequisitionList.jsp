...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a
				href="${pageContext.request.contextPath}/cn/storeRequisitionForm.do"
				...
				<table id="centralStoreRequisitionListTable"
					...
					<tbody>
						<c:forEach items="${subStoreRequisitionMstList}"
							...
							<tr>
								<td><a
									href="${pageContext.request.contextPath}/cn/storeRequisitionShow.do?id=${subStoreRequisitionMst.id}&&requisitionTo=${subStoreRequisitionMst.requisitionTo}"
								...
								<td><c:out value="${subStoreRequisitionMst.gatePassNo}" /></td>
								<td><fmt:formatDate
										value="${subStoreRequisitionMst.gatePassDate}"
										pattern="dd-MM-yyyy" /></td>
								<td>
