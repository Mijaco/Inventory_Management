					...
					<tbody>
						<c:forEach items="${constructionNatureList}"
							...
							<tr>
								...
								<td align="center"> <a class="green" onclick="updateConstructionNature(${loop.index}, ${constructionNature.id})" href="javascript:void(0)" title="Update"> <i class="glyphicon glyphicon-ok"></i> </</a></td>
							</tr>
							<% serial++; %>
						</c:forEach>
					</tbody>
