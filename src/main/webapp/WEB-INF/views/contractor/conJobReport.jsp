			...
			<div class="form-group col-xs-6">
				...
				<div class="col-xs-8">
					<input type="text" class="form-control" id="param1" name="param1"
						value="${empty workOrderNo ? 'CN0001' : workOrderNo}" style="width: 100%"> <input
			...
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr
								+ '?__report=desco/procurement/con_job_list_by_wo.rptdesign&__toolbar=false&__showtitle=false&__title=&P_WO_NO='
								+ param1;
