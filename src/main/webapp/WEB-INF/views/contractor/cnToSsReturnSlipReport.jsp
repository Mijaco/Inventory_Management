	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('rsReportFrame').src = birtAddr	+ '?__report=desco/procurement/cn_pd_ss_return_slip_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_RS_NO='+ param1;
