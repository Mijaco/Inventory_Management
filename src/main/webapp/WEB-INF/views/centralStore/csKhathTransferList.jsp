...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a href="${pageContext.request.contextPath}/cs/khath/transferForm.do"
				style="text-decoration: none;" class="btn btn-success btn-sm"> <span
				class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
				Create Project Transfer Form
			</a>
		</div>

		<h1 class="center blue"
			style="margin-top: 0; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Project
			Transfer List</h1>
	</div>
				...
				<table id="centralStorereceiveMstListTable"
					...
					<tbody>
						<c:forEach items="${khathTransferMstList}" var="khathTransferMst">
							<tr>
								<td><a
									href="${pageContext.request.contextPath}/cs/khath/khathTransferShow.do?transferNo=${khathTransferMst.transferNo}"
