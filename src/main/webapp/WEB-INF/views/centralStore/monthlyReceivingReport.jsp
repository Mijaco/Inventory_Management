...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"
			style="margin-top: 10px; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Monthly
			Receiving Report Statement</h1>
	</div>
			...
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr
								+ '?__report=desco/procurement/monthly_rr_statement.rptdesign&__toolbar=false&__showtitle=false&__title=&P_ITEM_ID='
