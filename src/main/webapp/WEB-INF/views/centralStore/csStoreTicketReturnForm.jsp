...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h4>
			<a href="#" style="text-decoration: none;">Store Ticket (Return)</a>
			/ New
		</h4>
		<div class="o_form_buttons_edit" style="display: block;">
			<a
				href="${pageContext.request.contextPath}/cs/storeTicket/returnedList.do"
		...
		<form method="POST"
			...
			<div class="oe_title">
				<div class="col-md-12 col-sm-12">
					<label for="returnedStatus" class="col-sm-2 control-label">
						Store Ticket Return For</label>
					<div class="col-sm-10">
						<select name="returnedStatus" class="form-control"
							id="returnedStatus" style="border: 0; border-bottom: 2px ridge;"
							name="gtPassNo">							
							<option value="Remove(Serviceable)">Serviceable</option>
							<option value="Remove(Un-serviceable)">Un-serviceable</option>
						</select>
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group">
						<label for="descoFormNo" class="col-sm-4 control-label">DESCO
							Form No.</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="descoFromNo"
								placeholder="1234" style="border: 0; border-bottom: 2px ridge;"
								name="descoFrmNo">
						</div>
					</div>
					...
					<div class="col-sm-10">&nbsp;&nbsp;</div>
					<div class="form-group">
						<label for="returnedBy" class="col-sm-4 control-label">Returned
							By</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="returnedBy"
								placeholder="Mr. xxx"
								style="border: 0; border-bottom: 2px ridge;" name="returnBy">
						</div>
					</div>
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="col-sm-10">&nbsp;&nbsp;</div>
					<div class="form-group">
						<label for="returnSlipNo" class="col-sm-4 col-md-4 control-label">Return
							Slip No.</label>
						<div class="col-sm-8 col-md-8">
					...
					<div class="col-sm-10 col-md-9">&nbsp;&nbsp;</div>
					<div class="form-group">
						<label for="returnFor" class="col-sm-4 col-md-4 control-label">Return
							For</label>
						<div class="col-sm-8 col-md-8">
					...
					<div class="col-sm-10 col-md-9">&nbsp;&nbsp;</div>
					<div class="form-group">
						<label for="returnDate" class="col-sm-4 col-md-4 control-label">Return
							Date</label>
						<div class="col-sm-8 col-md-8">
							<input type="date" class="form-control" id="returnDate"
								style="border: 0; border-bottom: 2px ridge;" name="returnDate" />
						</div>
					</div>
