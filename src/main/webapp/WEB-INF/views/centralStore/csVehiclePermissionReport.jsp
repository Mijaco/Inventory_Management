			...
			<div class="form-group col-xs-9">
				...
				<div class="col-xs-9">
					<input type="text" class="form-control" id="param1" name="param1"
						value="${param1}" style="width: 100%"> <!-- ST0720160500000061 -->
...
<script type="text/javascript">
	...
	function query() {
		...
		document.getElementById('requisitionReportFrame').src = birtAddr
				+ '?__report=desco/procurement/cs_vehicle_permission_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_SLIP_NO='
				+ param1;
	}
</script>
<!-- -------------------------------------------------------------------------------------- -->
