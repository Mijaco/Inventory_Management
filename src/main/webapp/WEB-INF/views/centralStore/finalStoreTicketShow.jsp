...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a
				href="${pageContext.request.contextPath}/cs/storeTicket/finalList.do"
	...
	<div class="row"
		...
		<div class="oe_title">
			...
			<table class="col-sm-12 table">
				...
				<c:if
					test="${csStoreTicketMst.storeTicketType eq 'LS_CS_REQUISITION' ||
				csStoreTicketMst.storeTicketType eq 'SS_CS_REQUISITION'}">
					<tr class="">
						<td class="success">Issued To:</td>
						<td class="info">${csStoreTicketMst.issuedTo}</td>
						<td class="success">Issued For:</td>
						<td class="info">${csStoreTicketMst.issuedFor}-(${csStoreTicketMst.sndCode})</td>
				...
				<c:if
					test="${csStoreTicketMst.storeTicketType eq 'LS_CS_RETURN_SLIP' ||
				csStoreTicketMst.storeTicketType eq 'SS_CS_RETURN_SLIP'}">
					<tr class="">
						<td class="success">Received From:</td>
						<td class="info">${csStoreTicketMst.receivedFrom}</td>
						<td class="success">Return For :</td>
						<td class="info">${csStoreTicketMst.returnFor}-(${csStoreTicketMst.sndCode})</td>
				...
				<tr class="">
					...
					<td class="info">${csStoreTicketMst.storeTicketType}</td>
