...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h1 class="center blue"
			style="margin-top: 10px; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Receiving
			Report</h1>
	</div>
		...
		<div class="col-sm-12 table-responsive">
			...
			<div class="form-group col-xs-6">
				<div class="form-group col-xs-4">
					<label for="exampleInputName2">Receiving Report No.</label>
				</div>
				<div class="col-xs-8">
					<input type="text" class="form-control" id="param1" name="param1"
						value="RR0720160500000061" style="width: 100%"> <input
			...
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr
								+ '?__report=desco/procurement/cs_receiving_report.rptdesign&__toolbar=false&__showtitle=false&__title=&P_RR_NO='
								+ param1;
