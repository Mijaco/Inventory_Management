							...
							<div style="width: 1200px;" >
								<c:if test="${!empty csStoreTicketDtlList}">
									<table id="requisitionListTable"
										...
										<tbody>
											<c:forEach items="${csStoreTicketDtlList}"
												var="csStoreTicketDtl">
												<tr>
													<td><input type="text" name="itemId"
														value="${csStoreTicketDtl.itemId}" readonly="readonly" /></td>
													<td><input type="text" name="description"
														title="${csStoreTicketDtl.description}"
														value="${csStoreTicketDtl.description}" readonly="readonly" /></td>													
													<td><input type="text" name="uom" readonly="readonly"
														 value="${csStoreTicketDtl.uom}" /></td>
													<td><input type="text" name="ledgerName" readonly="readonly"
														value="${csStoreTicketDtl.ledgerName}" /></td>
													...
													<td><input type="text" name="remarks"
														value="${csStoreTicketDtl.remarks}" /></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
														...
														<c:forEach items="${csRequisitionDtlList}"
															...
															<tr>
																...
																<td><input type="text" name="receivedQty"
																	...
																	readonly="readonly" /></td>
																<td><input type="text" name="quantity"
																	value="${csRequisitionDtl.quantityIssued}"
