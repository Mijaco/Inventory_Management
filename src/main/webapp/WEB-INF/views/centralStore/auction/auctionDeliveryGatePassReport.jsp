	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/auction_delivery_gate_pass.rptdesign&__toolbar=false&__showtitle=false&__title=&P_GATE_PASS_NO='+ param1;
