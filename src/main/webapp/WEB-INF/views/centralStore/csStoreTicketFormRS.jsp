...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row"
		...
		<!-- --------------------- -->
		<form method="POST"
			action="${pageContext.request.contextPath}/cs/itemRecieved/saveStoreTicketForCSReturnSlip.do">
			<div class="oe_title">
				...
				<div class="col-md-12" style="padding-top: 15px;">
					<div class="col-xs-12 col-sm-6">
						<button type="button" id="saveStoreTicket"
...
<script>
	$(document).ready( function() {
		$('#saveStoreTicket').click( function() {
			var haserror = false;
			
			if( haserror == true ) {
				return;
			} else {
				$('#saveStoreTicket').prop('disabled', true);
				$('form').submit();
			}
		});
	});
