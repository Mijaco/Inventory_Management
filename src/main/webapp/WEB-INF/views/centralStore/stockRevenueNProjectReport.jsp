			...
			<div class="form-group col-xs-6">
				...
				<div class="col-xs-8">
					<input type="text" class="form-control" id="param1" name="param1"
						value="150.103" style="width: 100%"> <input
	...
	$(document)
			.ready(
					function() {
						...
						+ '?__report=desco/procurement/revenue_n_project_ledger_cross_tab.rptdesign&__toolbar=false&__showtitle=false&__title=&P_ITEM_ID='
						+ param1;
					});
