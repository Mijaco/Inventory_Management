...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h4>
			<a href="#" style="text-decoration: none;">Return Slip</a> / List
		</h4>
		<div class="o_form_buttons_edit" style="display: block;">
			<a
				href="${pageContext.request.contextPath}/cs/store/returnSlipForm.do"
	...
	<div class="row" style="background-color: white; padding: 10px; padding-left: 20px; margin: 10px;">
		...
		<div class="col-sm-12 table-responsive">
			<c:if test="${empty returnSlipList}">
			...
			<c:if test="${!empty returnSlipList}">
				...
				<table id="requisitionListTable"
					...
					<tbody>
						<c:forEach items="${returnSlipList}" var="returnSlip">
							<tr>
