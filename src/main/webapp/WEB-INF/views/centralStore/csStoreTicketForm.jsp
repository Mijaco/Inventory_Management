					...
					<div>
						<input type="hidden" class="form-control" id="createdBy"
							...
							<input type="hidden" class="form-control" id="id"
								style="border: 0; border-bottom: 2px ridge;" name="id"
											...
											<c:forEach items="${csProcItemRcvDtlList}"
												...
												<tr>
													...
													<td><input type="text" name="description"
														value="${csProcItemRcvDtl.description}" readonly="readonly"/></td>
													<td><input type="text" name="uom" readonly="readonly"
														value="${csProcItemRcvDtl.uom}" /></td>
													...
													<td><input type="text" name="remarks"
														value="${csProcItemRcvDtl.remarks}" /></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
