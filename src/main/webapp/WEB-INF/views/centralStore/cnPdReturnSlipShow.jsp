	...
	<div class="row"
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 text-center">
				<button class="btn btn-primary" onclick="approveCnPdReturnSlip()" id="approveButton"
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/centralStore/cnPdReturnSlipShow.js"></script>
<!-- ------------------------------------Start of Footer-------------------------------------------------- -->
