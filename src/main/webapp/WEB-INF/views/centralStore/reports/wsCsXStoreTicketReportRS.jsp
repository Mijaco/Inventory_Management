	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('requisitionReportFrame').src = birtAddr	+ '?__report=desco/procurement/wsx_to_cs_ret_st.rptdesign&__toolbar=false&__showtitle=false&__title=&P_TICKET_NO='+ param1;
