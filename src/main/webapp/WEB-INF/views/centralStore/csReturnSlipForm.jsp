...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h4>
			<a href="#" style="text-decoration: none;">Return Slip</a> / New
		</h4>
		<div class="o_form_buttons_edit" style="display: block;">
			<a href="${pageContext.request.contextPath}/cs/returnSlip/list.do" style="text-decoration: none;"
	...
	<div class="row"
		...
		<!-- --------------------- -->
		<form method="POST"
			action="${pageContext.request.contextPath}/cs/returnSlip/save.do">
			<div class="oe_title">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="rsNo"
								placeholder="RS-1234" value="${rsNo}"
				...
				<div class="col-md-6 col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8 col-md-8">
							<input type="date" class="form-control" id="rsDate"
											...
											<div class="aaa">
												...
												<div class="col-xs-12 entry" id="myArea0">
													<div class="row">
														...
														<div class="form-group col-sm-2 col-xs-12">
															<input class="form-control uom" name="qtyRetrun"
																type="text" placeholder="Qty Return"
																style="border: 0; border-bottom: 2px ridge;" />
														</div>
														<div class="form-group col-sm-1 col-xs-12">
															<input class="form-control" name="qtyReceived"
																type="text" placeholder="Qty Receive"
																style="border: 0; border-bottom: 2px ridge;" />
														</div>
														<div class="form-group col-sm-3 col-xs-12">
