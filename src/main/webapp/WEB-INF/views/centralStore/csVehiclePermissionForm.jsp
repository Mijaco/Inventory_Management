...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<div class="o_form_buttons_edit" style="display: block;">
			<a
				href="${pageContext.request.contextPath}/cs/vehiclePermissionList.do"
				style="text-decoration: none;" class="btn btn-primary btn-sm"> <span
				class="glyphicon glyphicon-th-list" aria-hidden="true"> </span>
				Vehicle Permission List
			</a>

			<h1 class="center blue" style="margin-top: 0; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">
	...
	<div class="container">
		<div class="row"
			...
			<!-- --------------------- -->
			<form method="POST"
				action="${pageContext.request.contextPath}/cs/saveVehiclePermission.do">
				<div class="oe_title">

					<div class="col-md-6 col-sm-6">
						<%-- <div class="col-sm-10">&nbsp;&nbsp;</div>
					<div class="form-group">
						<label for="slipNo" class="col-sm-5 control-label">Slip
							No</label>
						<div class="col-sm-7">
							<input type="text" class="form-control" id="slipNo"
								value="${slipNo }" style="border: 0; border-bottom: 2px ridge;"
								name="slipNo" readonly/>
						</div>
					</div> --%>
						...
						<div class="form-group">
							<label for="requisitionBy" class="col-sm-5 control-label">Requisition
								By&nbsp;<strong class='red'>*</strong></label>
							<div class="col-sm-7">
					...
					<div class="col-md-6 col-sm-6">
						...
						<div class="form-group">
							<label for="vehicleNumber"
								class="col-sm-5 col-md-5 control-label">Vehicle Number&nbsp;<strong class='red'>*</strong></label>
							<div class="col-sm-7 col-md-7">
					...
					<!-- 							<button type="submit" -->
					<!-- 								class="width-20 pull-right btn btn-sm  -->
					<!-- 						btn-success"> -->
