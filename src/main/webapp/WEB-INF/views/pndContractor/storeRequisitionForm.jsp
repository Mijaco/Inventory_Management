...
<div class="container-fluid icon-box" style="background-color: #858585;">
	<div class="row"
		...
		<h2 class="center blue"
			style="margin-top: 0; font-style: italic; font-family: 'Ubuntu Condensed', sans-serif;">Contractor Requisition</h2>
	...
	<div class="row"
		...
		<!-- --------------------- -->
		<form method="POST"
			action="${pageContext.request.contextPath}/cnpd/pnd/storeRequisitionNext.do">
			<div class="oe_title">
				<div class="col-md-6 col-sm-6">
					<div class="form-group">
						<label for="identerDesignation" class="col-sm-4 control-label">Indentor:&nbsp;<strong class='red'>*</strong>
						</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<strong class="receivedBy hide text-danger">This field is required</strong>
						</div>
					</div>
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group">
						<label for="jobNo" class="col-sm-4 control-label">Job No:&nbsp;<strong class='red'>*</strong></label>
						<div class="col-sm-8">
							<select multiple="multiple" id="pndJobMst" name="jobNo"
								name="my-select[]">
								<c:if test="${!empty pndJobMstList}">
									<c:forEach items="${pndJobMstList}" var="pndJobMst">
										<option value="${pndJobMst.id}">
											<c:out value="${pndJobMst.jobNo}" /></option>
									</c:forEach>
								</c:if>
							</select>
						</div>
