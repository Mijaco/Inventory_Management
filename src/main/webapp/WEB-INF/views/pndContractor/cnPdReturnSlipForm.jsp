...
<div class="container-fluid icon-box" style="background-color: #858585;">
	...
	<div class="row"
		...
		<!-- --------------------- -->
		<form method="POST"
			action="${pageContext.request.contextPath}/cn/pd/returnSlip/Save.do">
			<div class="oe_title">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="receiveFrom"
								value="${contractor.contractorName}" readOnly="readOnly"
				...
				<div class="col-md-6 col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8 col-md-8">
							<select class="form-control requisitionTo" name="returnTo"
								id="returnTo" style="border: 0; border-bottom: 2px ridge;">
					...
					<div class="form-group">
						...
						<div class="col-sm-8 col-md-8 bold">
							<b> <fmt:formatDate value="${contractor.contractDate}"
							...
							<div class="table">
								<div style="width: 2000px;">
									...
									<div class="col-xs-12">
										...
										<div class="form-group col-sm-1 col-xs-12">
											<b>Total Return&nsbp;<strong style="color: red;">*</strong></b>
										</div>
										<div class="form-group col-sm-1 col-xs-12 center">
											<b>Job No.</b>
										</div>
										<div class="form-group col-sm-1 col-xs-12">
											<b>Remarks</b>
															...
															<div class="row">
																...
																<div class="form-group col-sm-1 col-xs-12">
																	<select class="form-control category" name="category"
																		id="category0" onchange="categoryLeaveChange(this)"
																		style="border: 0; border-bottom: 2px ridge;">
																		<option disabled selected>Category</option>
																...
																<div class="form-group col-sm-2 col-xs-12">
																	<input type="hidden" name="description"
																		...
																		class="form-control itemName" name="itemName"
																		id="itemName0" onchange="itemLeaveChange(this)"
																		style="border: 0; border-bottom: 2px ridge;">
																...
																<div class="form-group col-sm-1 col-xs-12">
																	<input class="form-control qtyUnServiceable"
																		...
																		id="qtyUnServiceable0" step="0.001"
																		onblur="setTotalCost(this)" value="0"
																		style="border: 0; border-bottom: 2px ridge;" />
																</div>
																<div class="form-group col-sm-1 col-xs-12">
...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/pndContractor/cnPdReturnSlipForm.js"></script>
<!-- ------------------------------------Start of Footer-------------------------------------------------- -->
